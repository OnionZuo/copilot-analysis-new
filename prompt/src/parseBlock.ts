var _BaseBlockParser = class _BaseBlockParser {
...
,var BaseBlockParser = _BaseBlockParser,
  _RegexBasedBlockParser = class _RegexBasedBlockParser extends BaseBlockParser {
...
,var RegexBasedBlockParser = _RegexBasedBlockParser;
...
,var _TreeSitterBasedBlockParser = class _TreeSitterBasedBlockParser extends BaseBlockParser {
...
,var TreeSitterBasedBlockParser = _TreeSitterBasedBlockParser,
  wasmLanguageToBlockParser = {
    ...
    c_sharp: new TreeSitterBasedBlockParser("csharp", {}, new Map([]), [], "block", null, !0),
    java: new TreeSitterBasedBlockParser("java", {}, new Map([]), [], "block", null, !0)
  };

,function getBlockParser(languageId) {
  if (!isSupportedLanguageId(languageId)) throw new Error(`Language ${languageId} is not supported`);
...
,function createWorker(workerName, workerData) {
  return new NIe.Worker(XR.path.resolve(XR.path.extname(__filename) !== ".ts" ? __dirname : XR.path.resolve(__dirname, "../../dist"), workerName), {
