...
${children}
  ...
  return isVirtual(tree) || isTop(tree) ? `${prefix}vnode(${tree.indentation}, ${labelString}, ${children})` : isBlank(tree) ? `${prefix}blank(${labelString != null ? labelString : ""})` : `${prefix}lnode(${tree.indentation}, ${labelString}, ${JSON.stringify(tree.sourceLine)}, ${children})`;
