var APP_INSIGHTS_KEY = "7d7048df-6dd0-4048-bb23-b716c1461f8f",
  ...
  _TelemetryInitialization = class _TelemetryInitialization {
    ...
    get isEnabled() {
      var _a;
      return (_a = this._enabled) != null ? _a : !1;
    }
...
,__name(_TelemetryInitialization, "TelemetryInitialization");

,var TelemetryInitialization = _TelemetryInitialization;

,function setupTelemetryReporters(ctx, telemetryNamespace, telemetryEnabled) {
