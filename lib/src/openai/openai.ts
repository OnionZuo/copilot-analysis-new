function convertToAPIChoice(ctx, completionText, jsonData, choiceIndex, requestId, blockFinished, telemetryData) {
...
`, "\n```"];
},__name(getStops, "getStops");

,function getTopP(ctx) {
  return 1;
},__name(getTopP, "getTopP");

,function getMaxSolutionTokens(ctx) {
