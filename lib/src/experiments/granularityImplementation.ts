...
,__name(_GranularityImplementation, "GranularityImplementation");

,var GranularityImplementation = _GranularityImplementation,
...
,__name(_ConstantGranularity, "ConstantGranularity");

,var ConstantGranularity = _ConstantGranularity,
...
,__name(_TimeBucketGranularity, "TimeBucketGranularity");

,var TimeBucketGranularity = _TimeBucketGranularity;