var http = fn(require("http"));

,var PROXY_AUTHORIZATION_REQUIRED = 407,
  logger = new Logger("proxySocketFactory"),
  _ProxySocketFactory = class _ProxySocketFactory {};

,__name(_ProxySocketFactory, "ProxySocketFactory");

,var ProxySocketFactory = _ProxySocketFactory,
...
,__name(_ProxySocketError, "ProxySocketError");

,var ProxySocketError = _ProxySocketError;
...
,var _KerberosProxySocketFactory = class _KerberosProxySocketFactory extends ProxySocketFactory {
...
,__name(_KerberosProxySocketFactory, "KerberosProxySocketFactory");

,var KerberosProxySocketFactory = _KerberosProxySocketFactory,
  _TunnelingProxySocketFactory = class _TunnelingProxySocketFactory extends ProxySocketFactory {
    ...
    async createSocket(requestOptions, proxySettings) {
      ...
      return new Promise((resolve, reject) => {
        ...
        let connectRequest = Wze.request(connectOptions);
...
,__name(_TunnelingProxySocketFactory, "TunnelingProxySocketFactory");

,var TunnelingProxySocketFactory = _TunnelingProxySocketFactory,
...
,__name(_KerberosLoader, "KerberosLoader");

,var KerberosLoader = _KerberosLoader;