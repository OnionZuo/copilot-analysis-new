...
,var _InlineUserPromptStrategy = class _InlineUserPromptStrategy extends AbstractUserPromptStrategy {
  suffix(turnContext) {
    return qqe.dedent`
...
,__name(_InlineUserPromptStrategy, "InlineUserPromptStrategy");

,var InlineUserPromptStrategy = _InlineUserPromptStrategy;