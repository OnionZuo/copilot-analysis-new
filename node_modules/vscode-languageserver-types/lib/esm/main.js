var DocumentUri;,(function (DocumentUri) {
...
})(Position || (Position = {}));,var Range;,(function (Range) {
...
})(Range || (Range = {}));,var Location;,(function (Location) {
...
})(Location || (Location = {}));,var LocationLink;,(function (LocationLink) {
...
})(LocationLink || (LocationLink = {}));,var Color;,(function (Color) {
...
})(Color || (Color = {}));,var ColorInformation;,(function (ColorInformation) {
...
})(ColorInformation || (ColorInformation = {}));,var ColorPresentation;,(function (ColorPresentation) {
...
})(ColorPresentation || (ColorPresentation = {}));,var FoldingRangeKind;,(function (FoldingRangeKind) {
  FoldingRangeKind.Comment = "comment", FoldingRangeKind.Imports = "imports", FoldingRangeKind.Region = "region";
})(FoldingRangeKind || (FoldingRangeKind = {}));,var FoldingRange;,(function (FoldingRange) {
...
})(FoldingRange || (FoldingRange = {}));,var DiagnosticRelatedInformation;,(function (DiagnosticRelatedInformation) {
...
})(DiagnosticRelatedInformation || (DiagnosticRelatedInformation = {}));,var DiagnosticSeverity;,(function (DiagnosticSeverity) {
  DiagnosticSeverity.Error = 1, DiagnosticSeverity.Warning = 2, DiagnosticSeverity.Information = 3, DiagnosticSeverity.Hint = 4;
})(DiagnosticSeverity || (DiagnosticSeverity = {}));,var DiagnosticTag;,(function (DiagnosticTag) {
  DiagnosticTag.Unnecessary = 1, DiagnosticTag.Deprecated = 2;
})(DiagnosticTag || (DiagnosticTag = {}));,var CodeDescription;,(function (CodeDescription) {
  function is(value) {
    let candidate = value;
    return Is.objectLiteral(candidate) && Is.string(candidate.href);
  }
  __name(is, "is"), CodeDescription.is = is;
})(CodeDescription || (CodeDescription = {}));,var Diagnostic;,(function (Diagnostic) {
...
})(Diagnostic || (Diagnostic = {}));,var Command;,(function (Command) {
...
})(Command || (Command = {}));,var TextEdit;,(function (TextEdit) {
...
})(TextEdit || (TextEdit = {}));,var ChangeAnnotation;,(function (ChangeAnnotation) {
...
})(ChangeAnnotation || (ChangeAnnotation = {}));,var ChangeAnnotationIdentifier;,(function (ChangeAnnotationIdentifier) {
  function is(value) {
    let candidate = value;
    return Is.string(candidate);
  }
  __name(is, "is"), ChangeAnnotationIdentifier.is = is;
})(ChangeAnnotationIdentifier || (ChangeAnnotationIdentifier = {}));,var AnnotatedTextEdit;,(function (AnnotatedTextEdit) {
...
})(AnnotatedTextEdit || (AnnotatedTextEdit = {}));,var TextDocumentEdit;,(function (TextDocumentEdit) {
...
})(TextDocumentEdit || (TextDocumentEdit = {}));,var CreateFile;,(function (CreateFile) {
...
})(CreateFile || (CreateFile = {}));,var RenameFile;,(function (RenameFile) {
...
})(RenameFile || (RenameFile = {}));,var DeleteFile;,(function (DeleteFile) {
  function create(uri, options, annotation) {
    let result = {
      kind: "delete",
      uri: uri
...
})(DeleteFile || (DeleteFile = {}));,var WorkspaceEdit;,(function (WorkspaceEdit) {
  function is(value) {
    let candidate = value;
...
})(WorkspaceEdit || (WorkspaceEdit = {}));,var TextDocumentIdentifier;,(function (TextDocumentIdentifier) {
  function create(uri) {
    return {
      uri: uri
    };
...
})(TextDocumentIdentifier || (TextDocumentIdentifier = {}));,var VersionedTextDocumentIdentifier;,(function (VersionedTextDocumentIdentifier) {
...
})(VersionedTextDocumentIdentifier || (VersionedTextDocumentIdentifier = {}));,var OptionalVersionedTextDocumentIdentifier;,(function (OptionalVersionedTextDocumentIdentifier) {
  function create(uri, version) {
    return {
      uri: uri,
      version: version
...
})(OptionalVersionedTextDocumentIdentifier || (OptionalVersionedTextDocumentIdentifier = {}));,var TextDocumentItem;,(function (TextDocumentItem) {
...
})(TextDocumentItem || (TextDocumentItem = {}));,var MarkupKind;,(function (MarkupKind) {
...
})(MarkupKind || (MarkupKind = {}));,var MarkupContent;,(function (MarkupContent) {
  function is(value) {
    let candidate = value;
    return Is.objectLiteral(value) && MarkupKind.is(candidate.kind) && Is.string(candidate.value);
  }
  __name(is, "is"), MarkupContent.is = is;
})(MarkupContent || (MarkupContent = {}));,var CompletionItemKind;,(function (CompletionItemKind) {
...
})(CompletionItemKind || (CompletionItemKind = {}));,var InsertTextFormat;,(function (InsertTextFormat) {
  InsertTextFormat.PlainText = 1, InsertTextFormat.Snippet = 2;
})(InsertTextFormat || (InsertTextFormat = {}));,var CompletionItemTag;,(function (CompletionItemTag) {
  CompletionItemTag.Deprecated = 1;
})(CompletionItemTag || (CompletionItemTag = {}));,var InsertReplaceEdit;,(function (InsertReplaceEdit) {
...
})(InsertReplaceEdit || (InsertReplaceEdit = {}));,var InsertTextMode;,(function (InsertTextMode) {
  InsertTextMode.asIs = 1, InsertTextMode.adjustIndentation = 2;
})(InsertTextMode || (InsertTextMode = {}));,var CompletionItemLabelDetails;,(function (CompletionItemLabelDetails) {
  function is(value) {
    let candidate = value;
    return candidate && (Is.string(candidate.detail) || candidate.detail === void 0) && (Is.string(candidate.description) || candidate.description === void 0);
  }
  __name(is, "is"), CompletionItemLabelDetails.is = is;
})(CompletionItemLabelDetails || (CompletionItemLabelDetails = {}));,var CompletionItem;,(function (CompletionItem) {
...
})(CompletionItem || (CompletionItem = {}));,var CompletionList;,(function (CompletionList) {
...
})(CompletionList || (CompletionList = {}));,var MarkedString;,(function (MarkedString) {
...
})(MarkedString || (MarkedString = {}));,var Hover;,(function (Hover) {
  function is(value) {
    let candidate = value;
    return !!candidate && Is.objectLiteral(candidate) && (MarkupContent.is(candidate.contents) || MarkedString.is(candidate.contents) || Is.typedArray(candidate.contents, MarkedString.is)) && (value.range === void 0 || Range.is(value.range));
  }
  __name(is, "is"), Hover.is = is;
})(Hover || (Hover = {}));,var ParameterInformation;,(function (ParameterInformation) {
...
})(ParameterInformation || (ParameterInformation = {}));,var SignatureInformation;,(function (SignatureInformation) {
...
})(SignatureInformation || (SignatureInformation = {}));,var DocumentHighlightKind;,(function (DocumentHighlightKind) {
  DocumentHighlightKind.Text = 1, DocumentHighlightKind.Read = 2, DocumentHighlightKind.Write = 3;
})(DocumentHighlightKind || (DocumentHighlightKind = {}));,var DocumentHighlight;,(function (DocumentHighlight) {
...
})(DocumentHighlight || (DocumentHighlight = {}));,var SymbolKind;,(function (SymbolKind) {
...
})(SymbolKind || (SymbolKind = {}));,var SymbolTag;,(function (SymbolTag) {
  SymbolTag.Deprecated = 1;
})(SymbolTag || (SymbolTag = {}));,var SymbolInformation;,(function (SymbolInformation) {
...
})(SymbolInformation || (SymbolInformation = {}));,var WorkspaceSymbol;,(function (WorkspaceSymbol) {
...
})(WorkspaceSymbol || (WorkspaceSymbol = {}));,var DocumentSymbol;,(function (DocumentSymbol) {
...
})(DocumentSymbol || (DocumentSymbol = {}));,var CodeActionKind;,(function (CodeActionKind) {
...
})(CodeActionKind || (CodeActionKind = {}));,var CodeActionTriggerKind;,(function (CodeActionTriggerKind) {
  CodeActionTriggerKind.Invoked = 1, CodeActionTriggerKind.Automatic = 2;
})(CodeActionTriggerKind || (CodeActionTriggerKind = {}));,var CodeActionContext;,(function (CodeActionContext) {
...
})(CodeActionContext || (CodeActionContext = {}));,var CodeAction;,(function (CodeAction) {
...
})(CodeAction || (CodeAction = {}));,var CodeLens;,(function (CodeLens) {
...
})(CodeLens || (CodeLens = {}));,var FormattingOptions;,(function (FormattingOptions) {
...
})(FormattingOptions || (FormattingOptions = {}));,var DocumentLink;,(function (DocumentLink) {
...
})(DocumentLink || (DocumentLink = {}));,var SelectionRange;,(function (SelectionRange) {
...
})(SelectionRange || (SelectionRange = {}));,var SemanticTokenTypes;,(function (SemanticTokenTypes) {
...
})(SemanticTokenTypes || (SemanticTokenTypes = {}));,var SemanticTokenModifiers;,(function (SemanticTokenModifiers) {
...
})(SemanticTokenModifiers || (SemanticTokenModifiers = {}));,var SemanticTokens;,(function (SemanticTokens) {
  function is(value) {
    let candidate = value;
    return Is.objectLiteral(candidate) && (candidate.resultId === void 0 || typeof candidate.resultId == "string") && Array.isArray(candidate.data) && (candidate.data.length === 0 || typeof candidate.data[0] == "number");
  }
  __name(is, "is"), SemanticTokens.is = is;
})(SemanticTokens || (SemanticTokens = {}));,var InlineValueText;,(function (InlineValueText) {
...
})(InlineValueText || (InlineValueText = {}));,var InlineValueVariableLookup;,(function (InlineValueVariableLookup) {
...
})(InlineValueVariableLookup || (InlineValueVariableLookup = {}));,var InlineValueEvaluatableExpression;,(function (InlineValueEvaluatableExpression) {
...
})(InlineValueEvaluatableExpression || (InlineValueEvaluatableExpression = {}));,var InlineValueContext;,(function (InlineValueContext) {
...
})(InlineValueContext || (InlineValueContext = {}));,var InlayHintKind;,(function (InlayHintKind) {
  InlayHintKind.Type = 1, InlayHintKind.Parameter = 2;
  function is(value) {
    return value === 1 || value === 2;
  }
  __name(is, "is"), InlayHintKind.is = is;
})(InlayHintKind || (InlayHintKind = {}));,var InlayHintLabelPart;,(function (InlayHintLabelPart) {
...
})(InlayHintLabelPart || (InlayHintLabelPart = {}));,var InlayHint;,(function (InlayHint) {
...
})(InlayHint || (InlayHint = {}));,var StringValue;,(function (StringValue) {
...
})(StringValue || (StringValue = {}));,var InlineCompletionItem;,(function (InlineCompletionItem) {
...
})(InlineCompletionItem || (InlineCompletionItem = {}));,var InlineCompletionList;,(function (InlineCompletionList) {
...
})(InlineCompletionList || (InlineCompletionList = {}));,var InlineCompletionTriggerKind;,(function (InlineCompletionTriggerKind) {
  InlineCompletionTriggerKind.Invoked = 0, InlineCompletionTriggerKind.Automatic = 1;
})(InlineCompletionTriggerKind || (InlineCompletionTriggerKind = {}));,var SelectedCompletionInfo;,(function (SelectedCompletionInfo) {
  function create(range, text) {
    return {
      range: range,
      text: text
...
})(SelectedCompletionInfo || (SelectedCompletionInfo = {}));,var InlineCompletionContext;,(function (InlineCompletionContext) {
...
})(InlineCompletionContext || (InlineCompletionContext = {}));,var WorkspaceFolder;,(function (WorkspaceFolder) {
  function is(value) {
    let candidate = value;
    return Is.objectLiteral(candidate) && URI.is(candidate.uri) && Is.string(candidate.name);
  }
  __name(is, "is"), WorkspaceFolder.is = is;
})(WorkspaceFolder || (WorkspaceFolder = {}));,var TextDocument;,(function (TextDocument) {
  ...
  function applyEdits(document, edits) {
    let text = document.getText(),
      sortedEdits = mergeSort(edits, (a, b) => {
...
})(TextDocument || (TextDocument = {}));,var _FullTextDocument = class _FullTextDocument {
