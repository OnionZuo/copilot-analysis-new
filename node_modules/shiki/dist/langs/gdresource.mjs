var gdresource_exports = {};,__export(gdresource_exports, {
  default: () => gdresource
});,var lang,
  gdresource,
  init_gdresource = __esmMin(() => {
    init_gdshader();
    init_gdscript();
    lang = Object.freeze({
      ...
      repository: {
        ...
        data: {
          patterns: [{
            ...
            match: "(?<!\\w)([\\+\\-]?(0|([1-9]((\\d|_\\d)+)?))(?:(?:\\.(0|([1-9]((\\d|_\\d)+)?)))?[eE][\\+\\-]?[1-9]_?\\d*|(?:\\.[0-9_]*)))(?!\\w)",
            name: "constant.numeric.float.gdresource"
          }, {
            match: "(?<!\\w)((?:[\\+\\-]?(0|([1-9]((\\d|_\\d)+)?))))(?!\\w)",
    ...
    }), gdresource = [...gdshader, ...gdscript, lang];
  });