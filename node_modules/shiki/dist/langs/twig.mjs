var twig_exports = {};,__export(twig_exports, {
  default: () => twig
});,var lang,
  twig,
  init_twig = __esmMin(() => {
    ...
    lang = Object.freeze({
      ...
      repository: {
        ...
        "twig-macros": {
          begin: "(?<=[\\s\\(\\[\\{:,])([a-zA-Z_\\x{7f}-\\x{ff}][a-zA-Z0-9_\\x{7f}-\\x{ff}]*)(?:(\\.)([a-zA-Z_\\x{7f}-\\x{ff}][a-zA-Z0-9_\\x{7f}-\\x{ff}]*))?(\\()",
          beginCaptures: {
            1: {
        ...
        "twig-properties": {
          patterns: [{
            ...
            begin: "(?<=[a-zA-Z0-9_\\x{7f}-\\x{ff}])(\\.)([a-zA-Z_\\x{7f}-\\x{ff}][a-zA-Z0-9_\\x{7f}-\\x{ff}]*)(\\()",
            beginCaptures: {
              1: {
                name: "punctuation.separator.property.twig"
              },
            ...
            match: `(?<=[a-zA-Z0-9_\\x{7f}-\\x{ff}\\]])(?:(\\[)('[a-zA-Z_\\x{7f}-\\x{ff}][a-zA-Z0-9_\\x{7f}-\\x{ff}]*')(\\])|(\\[)("[a-zA-Z_\\x{7f}-\\x{ff}][a-zA-Z0-9_\\x{7f}-\\x{ff}]*")(\\])|(\\[)([a-zA-Z_\\x{7f}-\\x{ff}][a-zA-Z0-9_\\x{7f}-\\x{ff}]*)(\\]))`
          }]
        },
        "twig-statement-tag": {
          begin: "\\{%-?",
    ...
    }), twig = [...css, ...javascript, ...scss, ...php, ...python, ...ruby, lang];
  });