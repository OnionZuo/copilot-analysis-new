var latex_exports = {};,__export(latex_exports, {
  default: () => latex
});,var lang,
  latex,
  init_latex = __esmMin(() => {
...
Put specific matches for particular LaTeX keyword.functions before the last two more general functions`,
    ...
    }), latex = [...tex, ...shellscript, ...css, ...gnuplot, ...haskell, ...html, ...java, ...julia, ...javascript, ...lua, ...python, ...ruby, ...rust, ...typescript, ...xml, ...yaml, ...scala, lang];
  });