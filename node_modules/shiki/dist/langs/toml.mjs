var toml_exports = {};,__export(toml_exports, {
  default: () => toml
});,var lang,
  toml,
  init_toml = __esmMin(() => {
      ...
      repository: {
        ...
        primatives: {
          patterns: [{
            ...
            match: "\\G\\d{4}-(0[1-9]|1[012])-(?!00|3[2-9])[0-3]\\d([Tt ](?!2[5-9])[0-2]\\d:[0-5]\\d:(?!6[1-9])[0-6]\\d(\\.\\d+)?(Z|[+-](?!2[5-9])[0-2]\\d:[0-5]\\d)?)?",
            name: "constant.other.date.toml"
          }, {
            match: "\\G(?!2[5-9])[0-2]\\d:[0-5]\\d:(?!6[1-9])[0-6]\\d(\\.\\d+)?",
            ...
            match: "\\G([+-]?(0|([1-9]((\\d|_\\d)+)?)))(?=[.eE])(\\.(\\d((\\d|_\\d)+)?))?([eE]([+-]?\\d((\\d|_\\d)+)?))?",
