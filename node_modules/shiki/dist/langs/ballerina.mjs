var ballerina_exports = {};,__export(ballerina_exports, {
  default: () => ballerina
});,var lang,
  ballerina,
  init_ballerina = __esmMin(() => {
    lang = Object.freeze({
      ...
      repository: {
        "access-modifier": {
          patterns: [{
            match: "(?<![_$0-9A-Za-z])(?:(?<=\\.\\.\\.)|(?<!\\.))(public|private)(?![_$0-9A-Za-z])(?:(?=\\.\\.\\.)|(?!\\.))",
        ...
        annotationAttachment: {
          patterns: [{
            ...
            match: "(@)((?:[_$A-Za-z][_$0-9A-Za-z]*))\\s*(:?)\\s*((?:[_$A-Za-z][_$0-9A-Za-z]*)?)"
          }]
        },
        ...
        constrainType: {
          patterns: [{
            ...
            patterns: [{
              ...
              match: "\\b([_$A-Za-z][_$0-9A-Za-z]*)\\b",
        ...
        "enum-decl": {
          begin: "(?:\\b(const)\\s+)?\\b(enum)\\s+([_$A-Za-z][_$0-9A-Za-z]*)",
          beginCaptures: {
            1: {
        ...
        functionName: {
          patterns: [{
            ...
            match: "\\s+(\\b(self)|\\b(is|new|isolated|null|function|in)\\b|(string|int|boolean|float|byte|decimal|json|xml|anydata)\\b|\\b(readonly|error|map)\\b|([_$A-Za-z][_$0-9A-Za-z]*))"
          }]
        },
        functionParameters: {
          begin: "\\(|\\[",
        ...
        functionTypeReturnsParameter: {
          patterns: [{
            begin: "((?=record|object|function)|(?:[_$A-Za-z][_$0-9A-Za-z]*))",
            beginCaptures: {
              0: {
                name: "storage.type.ballerina"
              }
        ...
        identifiers: {
          patterns: [{
            ...
            match: "([_$A-Za-z][_$0-9A-Za-z]*)((\\.)([_$A-Za-z][_$0-9A-Za-z]*)(\\()(\\)))?"
          }, {
            match: "(\\')([_$A-Za-z][_$0-9A-Za-z]*)",
            name: "variable.other.property.ballerina"
          }, {
        ...
        "import-clause": {
          patterns: [{
            ...
            match: "(?<![_$0-9A-Za-z])(?:(?<=\\.\\.\\.)|(?<!\\.))(?:(\\bdefault)|(\\*)|(\\b[_$A-Za-z][_$0-9A-Za-z]*))"
          }, {
            match: "([_$A-Za-z][_$0-9A-Za-z]*)",
            name: "variable.other.readwrite.alias.ballerina"
          }]
        ...
        "object-member": {
          patterns: [{
            ...
            match: "(?:([_$A-Za-z][_$0-9A-Za-z]*)\\s*(?=(\\/\\*([^\\*]|(\\*[^\\/]))*\\*\\/\\s*)*:(\\s*\\/\\*([^\\*]|(\\*[^\\/]))*\\*\\/)*\\s*((((function\\s*[(<*])|(function\\s+)|([_$A-Za-z][_$0-9A-Za-z]*\\s*=>)))|((((<\\s*$)|((<\\s*([_$A-Za-z]|(\\{([^\\{\\}]|(\\{([^\\{\\}]|\\{[^\\{\\}]*\\})*\\}))*\\})|(\\(([^\\(\\)]|(\\(([^\\(\\)]|\\([^\\(\\)]*\\))*\\)))*\\))|(\\[([^\\[\\]]|(\\[([^\\[\\]]|\\[[^\\[\\]]*\\])*\\]))*\\]))([^=<>]|=[^<]|\\<\\s*([_$A-Za-z]|(\\{([^\\{\\}]|(\\{([^\\{\\}]|\\{[^\\{\\}]*\\})*\\}))*\\})|(\\(([^\\(\\)]|(\\(([^\\(\\)]|\\([^\\(\\)]*\\))*\\)))*\\))|(\\[([^\\[\\]]|(\\[([^\\[\\]]|\\[[^\\[\\]]*\\])*\\]))*\\]))([^=<>]|=[^<]|\\<\\s*([_$A-Za-z]|(\\{([^\\{\\}]|(\\{([^\\{\\}]|\\{[^\\{\\}]*\\})*\\}))*\\})|(\\(([^\\(\\)]|(\\(([^\\(\\)]|\\([^\\(\\)]*\\))*\\)))*\\))|(\\[([^\\[\\]]|(\\[([^\\[\\]]|\\[[^\\[\\]]*\\])*\\]))*\\]))([^=<>]|=[^<])*\\>)*\\>)*>\\s*)?[\\(]\\s*((([\\{\\[]\\s*)?$)|((\\{([^\\{\\}]|(\\{([^\\{\\}]|\\{[^\\{\\}]*\\})*\\}))*\\})\\s*((:\\s*\\{?$)|((\\s*([^<>\\(\\)\\{\\}]|\\<([^<>]|\\<([^<>]|\\<[^<>]+\\>)+\\>)+\\>|\\([^\\(\\)]+\\)|\\{[^\\{\\}]+\\})+\\s*)?=\\s*)))|((\\[([^\\[\\]]|(\\[([^\\[\\]]|\\[[^\\[\\]]*\\])*\\]))*\\])\\s*((:\\s*\\[?$)|((\\s*([^<>\\(\\)\\{\\}]|\\<([^<>]|\\<([^<>]|\\<[^<>]+\\>)+\\>)+\\>|\\([^\\(\\)]+\\)|\\{[^\\{\\}]+\\})+\\s*)?=\\s*))))))|((<\\s*([_$A-Za-z]|(\\{([^\\{\\}]|(\\{([^\\{\\}]|\\{[^\\{\\}]*\\})*\\}))*\\})|(\\(([^\\(\\)]|(\\(([^\\(\\)]|\\([^\\(\\)]*\\))*\\)))*\\))|(\\[([^\\[\\]]|(\\[([^\\[\\]]|\\[[^\\[\\]]*\\])*\\]))*\\]))([^=<>]|=[^<]|\\<\\s*([_$A-Za-z]|(\\{([^\\{\\}]|(\\{([^\\{\\}]|\\{[^\\{\\}]*\\})*\\}))*\\})|(\\(([^\\(\\)]|(\\(([^\\(\\)]|\\([^\\(\\)]*\\))*\\)))*\\))|(\\[([^\\[\\]]|(\\[([^\\[\\]]|\\[[^\\[\\]]*\\])*\\]))*\\]))([^=<>]|=[^<]|\\<\\s*([_$A-Za-z]|(\\{([^\\{\\}]|(\\{([^\\{\\}]|\\{[^\\{\\}]*\\})*\\}))*\\})|(\\(([^\\(\\)]|(\\(([^\\(\\)]|\\([^\\(\\)]*\\))*\\)))*\\))|(\\[([^\\[\\]]|(\\[([^\\[\\]]|\\[[^\\[\\]]*\\])*\\]))*\\]))([^=<>]|=[^<])*\\>)*\\>)*>\\s*)?[(]\\s*(\\/\\*([^\\*]|(\\*[^\\/]))*\\*\\/\\s*)*(([)]\\s*:)|((\\.\\.\\.\\s*)?[_$A-Za-z][_$0-9A-Za-z]*\\s*:)))|((<\\s*([_$A-Za-z]|(\\{([^\\{\\}]|(\\{([^\\{\\}]|\\{[^\\{\\}]*\\})*\\}))*\\})|(\\(([^\\(\\)]|(\\(([^\\(\\)]|\\([^\\(\\)]*\\))*\\)))*\\))|(\\[([^\\[\\]]|(\\[([^\\[\\]]|\\[[^\\[\\]]*\\])*\\]))*\\]))([^=<>]|=[^<]|\\<\\s*([_$A-Za-z]|(\\{([^\\{\\}]|(\\{([^\\{\\}]|\\{[^\\{\\}]*\\})*\\}))*\\})|(\\(([^\\(\\)]|(\\(([^\\(\\)]|\\([^\\(\\)]*\\))*\\)))*\\))|(\\[([^\\[\\]]|(\\[([^\\[\\]]|\\[[^\\[\\]]*\\])*\\]))*\\]))([^=<>]|=[^<]|\\<\\s*([_$A-Za-z]|(\\{([^\\{\\}]|(\\{([^\\{\\}]|\\{[^\\{\\}]*\\})*\\}))*\\})|(\\(([^\\(\\)]|(\\(([^\\(\\)]|\\([^\\(\\)]*\\))*\\)))*\\))|(\\[([^\\[\\]]|(\\[([^\\[\\]]|\\[[^\\[\\]]*\\])*\\]))*\\]))([^=<>]|=[^<])*\\>)*\\>)*>\\s*)?\\(\\s*(\\/\\*([^\\*]|(\\*[^\\/]))*\\*\\/\\s*)*(([_$A-Za-z]|(\\{([^\\{\\}]|(\\{([^\\{\\}]|\\{[^\\{\\}]*\\})*\\}))*\\})|(\\[([^\\[\\]]|(\\[([^\\[\\]]|\\[[^\\[\\]]*\\])*\\]))*\\])|(\\.\\.\\.\\s*[_$A-Za-z]))([^()\\'\\\"\\`]|(\\(([^\\(\\)]|(\\(([^\\(\\)]|\\([^\\(\\)]*\\))*\\)))*\\))|(\\'([^\\'\\\\]|\\\\.)*\\')|(\\\"([^\\\"\\\\]|\\\\.)*\\\")|(\\`([^\\`\\\\]|\\\\.)*\\`))*)?\\)(\\s*:\\s*([^<>\\(\\)\\{\\}]|\\<([^<>]|\\<([^<>]|\\<[^<>]+\\>)+\\>)+\\>|\\([^\\(\\)]+\\)|\\{[^\\{\\}]+\\})+)?\\s*=>))))))",
            name: "meta.object.member.ballerina"
          }, {
            captures: {
              0: {
            ...
            begin: "(?<![_$0-9A-Za-z])(?:(?<=\\.\\.\\.)|(?<!\\.))(as)\\s+",
            beginCaptures: {
              1: {
                name: "keyword.control.as.ballerina"
              }
            },
            end: "(?=[;),}\\]:?\\-\\+\\>]|\\|\\||\\&\\&|\\!\\=\\=|$|^|((?<![_$0-9A-Za-z])(?:(?<=\\.\\.\\.)|(?<!\\.))(as)\\s+))",
            name: "meta.object.member.ballerina"
          }, {
        ...
        parameter: {
          patterns: [{
            begin: "((?=record|object|function)|([_$A-Za-z][_$0-9A-Za-z]*)(?=\\|)|(?:[_$A-Za-z][_$0-9A-Za-z]*))",
            beginCaptures: {
              0: {
                name: "storage.type.ballerina"
              }
        ...
        "parameter-name": {
          patterns: [{
            ...
            match: "(?:(?<![_$0-9A-Za-z])(?:(?<=\\.\\.\\.)|(?<!\\.))\\s+)?(?:(\\.\\.\\.)\\s*)?(?<!=|:)(?<![_$0-9A-Za-z])(?:(?<=\\.\\.\\.)|(?<!\\.))(?:(this)|(string|int|boolean|float|byte|decimal|json|xml|anydata)|\\b(is|new|isolated|null|function|in)\\b|\\b(true|false)\\b|\\b(check|foreach|if|checkpanic)\\b|\\b(readonly|error|map)\\b|([_$A-Za-z][_$0-9A-Za-z]*))(?![_$0-9A-Za-z])(?:(?=\\.\\.\\.)|(?!\\.))\\s*(\\??)"
          }]
        },
        parameterTuple: {
          patterns: [{
        ...
        "self-literal": {
          patterns: [{
            ...
            match: "(\\bself\\b)\\s*(.)\\s*([_$A-Za-z][_$0-9A-Za-z]*)\\s*(?=\\()"
          }, {
            match: "(?<![_$0-9A-Za-z])(?:(?<=\\.\\.\\.)|(?<!\\.))self\\b(?!\\$)",
            name: "variable.language.this.ballerina"
          }]
        },
        "service-decl": {
        ...
        source: {
          patterns: [{
            begin: "(\\bsource\\b)\\s+([_$A-Za-z][_$0-9A-Za-z]*)",
            beginCaptures: {
              1: {
                name: "keyword.other.ballerina"
              },
        ...
        stringTemplate: {
          patterns: [{
            begin: "((string)|([_$A-Za-z][_$0-9A-Za-z]*))?(`)",
            beginCaptures: {
              1: {
        ...
        "type-annotation": {
          patterns: [{
            ...
            patterns: [{
              ...
              match: "\\b(is|new|isolated|null|function|in)\\b|\\b(true|false)\\b|\\b(check|foreach|if|checkpanic)\\b|\\b(readonly|error|map)\\b|\\b(var)\\b|([_$A-Za-z][_$0-9A-Za-z]*)((\\.)([_$A-Za-z][_$0-9A-Za-z]*)(\\()(\\)))?"
            }, {
              match: "\\?",
              name: "keyword.operator.optional.ballerina"
            }, {
        ...
        "type-primitive": {
          patterns: [{
            match: "(?<![_$0-9A-Za-z])(?:(?<=\\.\\.\\.)|(?<!\\.))(string|int|boolean|float|byte|decimal|json|xml|anydata)(?![_$0-9A-Za-z])(?:(?=\\.\\.\\.)|(?!\\.))",
            name: "support.type.primitive.ballerina"
          }]
        },
        "type-tuple": {
        ...
        typeDefinition: {
          patterns: [{
            begin: "(\\btype\\b)\\s+([_$A-Za-z][_$0-9A-Za-z]*)",
            beginCaptures: {
              1: {
                name: "keyword.other.ballerina"
              },
        ...
        "var-expr": {
          patterns: [{
            ...
            end: "(?!\\b(var))((?=;|}|;|^\\s*$|(?:^\\s*(?:abstract|async|class|const|declare|enum|export|function|import|interface|let|module|namespace|return|service|type|var)\\b))|((?<![_$0-9A-Za-z])(?:(?<=\\.\\.\\.)|(?<!\\.))(?=(if)\\s+))|((?<!^string|[^\\._$0-9A-Za-z]string|^int|[^\\._$0-9A-Za-z]int)(?=\\s*$)))",
            ...
            end: "(?!\\b(const(?!\\s+enum\\b)))((?=\\bannotation\\b|;|}|;|^\\s*$|(?:^\\s*(?:abstract|async|class|const|declare|enum|export|function|import|interface|let|module|namespace|return|service|type|var)\\b))|((?<!^string|[^\\._$0-9A-Za-z]string|^int|[^\\._$0-9A-Za-z]int)(?=\\s*$)))",
            name: "meta.var.expr.ballerina",
            patterns: [{
            ...
            end: "(?!\\b(var))((?=;|}|;|^\\s*$|(?:^\\s*(?:abstract|async|class|const|declare|enum|export|function|import|interface|let|module|namespace|return|service|type|var)\\b))|((?<!^string|[^\\._$0-9A-Za-z]string|^int|[^\\._$0-9A-Za-z]int)(?=\\s*$)))",
            name: "meta.var.expr.ballerina",
            patterns: [{
              include: "#xml"
            }, {
        ...
        "var-single-variable": {
          patterns: [{
            begin: "((string|int|boolean|float|byte|decimal|json|xml|anydata)|\\b(readonly|error|map)\\b|([_$A-Za-z][_$0-9A-Za-z]*))(?=\\s+|\\;|\\>|\\|)",
            beginCaptures: {
              2: {
                name: "support.type.primitive.ballerina"
              },
