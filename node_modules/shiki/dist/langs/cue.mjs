var cue_exports = {};,__export(cue_exports, {
  default: () => cue
});,var lang,
  cue,
  init_cue = __esmMin(() => {
        ...
        expression: {
          patterns: [{
            ...
            patterns: [{
              ...
              patterns: [{
                patterns: [{
                  match: "(?<![\\p{L}\\p{Nd}_\\.])\\d(?:_?\\d)*\\.(?:\\d(?:_?\\d)*)?(?:[eE][\\+\\-]?\\d(?:_?\\d)*)?(?![\\p{L}\\p{Nd}_\\.])",
                  name: "constant.numeric.float.decimal"
                }, {
                  match: "(?<![\\p{L}\\p{Nd}_\\.])\\d(?:_?\\d)*[eE][\\+\\-]?\\d(?:_?\\d)*(?![\\p{L}\\p{Nd}_\\.])",
                  name: "constant.numeric.float.decimal"
                }, {
                  match: "(?<![\\p{L}\\p{Nd}_\\.])\\.\\d(?:_?\\d)*(?:[eE][\\+\\-]?\\d(?:_?\\d)*)?(?![\\p{L}\\p{Nd}_\\.])",
                  name: "constant.numeric.float.decimal"
                ...
                patterns: [{
                  patterns: [{
                    match: "(?<![\\p{L}\\p{Nd}_\\.])(?:0|[1-9](?:_?\\d)*)(?:\\.\\d(?:_?\\d)*)?(?:[KMGTPEYZ]i?)(?![\\p{L}\\p{Nd}_\\.])",
                    name: "constant.numeric.integer.other"
                  }, {
                    match: "(?<![\\p{L}\\p{Nd}_\\.])\\.\\d(?:_?\\d)*(?:[KMGTPEYZ]i?)(?![\\p{L}\\p{Nd}_\\.])",
                    name: "constant.numeric.integer.other"
                  }]
                }, {
                  match: "(?<![\\p{L}\\p{Nd}_\\.])(?:0|[1-9](?:_?\\d)*)(?![\\p{L}\\p{Nd}_\\.])",
