var asciidoc_exports = {};,__export(asciidoc_exports, {
  default: () => asciidoc
});,var lang,
  asciidoc,
  init_asciidoc = __esmMin(() => {
    init_html();
    init_yaml();
    init_csv();
    init_c();
    ...
    lang = Object.freeze({
      ...
      aliases: ["adoc"]
    }), asciidoc = [...html, ...yaml, ...csv, ...c, ...clojure, ...coffee, ...cpp, ...css, ...csharp, ...diff, ...docker, ...elixir, ...elm, ...erlang, ...go, ...groovy, ...haskell, ...java, ...javascript, ...json, ...jsx, ...julia, ...kotlin, ...less, ...make, ...objective_c, ...ocaml, ...perl, ...python, ...r, ...ruby, ...rust, ...sass, ...scala, ...scss, ...shellscript, ...sql, ...swift, ...toml, ...typescript, ...xml, lang];
  });