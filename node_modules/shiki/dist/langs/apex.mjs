var apex_exports = {};,__export(apex_exports, {
  default: () => apex
});,var lang,
  apex,
  init_apex = __esmMin(() => {
    lang = Object.freeze({
      ...
      repository: {
        ...
        "array-creation-expression": {
          begin: "\\b(new)\\b\\s*(?<type_name>(?:(?:(?:(?<identifier>@?[_A-Za-z][_0-9A-Za-z]*)\\s*\\:\\:\\s*)?(?<name_and_type_args>\\g<identifier>\\s*(?<type_args>\\s*<(?:[^<>]|\\g<type_args>)+>\\s*)?)(?:\\s*\\.\\s*\\g<name_and_type_args>)*)(?:\\s*\\?\\s*)?(?:\\s*\\[(?:\\s*,\\s*)*\\]\\s*)*))?\\s*(?=\\[)",
          beginCaptures: {
            1: {
        ...
        "cast-expression": {
          ...
          match: "(\\()\\s*(?<type_name>(?:(?:(?:(?<identifier>@?[_A-Za-z][_0-9A-Za-z]*)\\s*\\:\\:\\s*)?(?<name_and_type_args>\\g<identifier>\\s*(?<type_args>\\s*<(?:[^<>]|\\g<type_args>)+>\\s*)?)(?:\\s*\\.\\s*\\g<name_and_type_args>)*)(?:\\s*\\?\\s*)?(?:\\s*\\[(?:\\s*,\\s*)*\\]\\s*)*))\\s*(\\))(?=\\s*@?[_0-9A-Za-z\\(])"
        },
        "catch-clause": {
          begin: "(?<!\\.)\\b(catch)\\b",
          beginCaptures: {
          ...
          patterns: [{
            ...
            patterns: [{
              ...
              match: "(?<type_name>(?:(?:(?:(?<identifier>@?[_A-Za-z][_0-9A-Za-z]*)\\s*\\:\\:\\s*)?(?<name_and_type_args>\\g<identifier>\\s*(?<type_args>\\s*<(?:[^<>]|\\g<type_args>)+>\\s*)?)(?:\\s*\\.\\s*\\g<name_and_type_args>)*)(?:\\s*\\?\\s*)?(?:\\s*\\[(?:\\s*,\\s*)*\\]\\s*)*))\\s*(?:(\\g<identifier>)\\b)?"
            }]
          }, {
            include: "#comment"
          }, {
        ...
        "class-declaration": {
          ...
          patterns: [{
            begin: "\\b(class)\\b\\s+(@?[_A-Za-z][_0-9A-Za-z]*)\\s*",
            beginCaptures: {
              1: {
        ...
        "extends-class": {
          begin: "(extends)\\b\\s+([_A-Za-z][_0-9A-Za-z]*)",
          beginCaptures: {
            1: {
        ...
        "field-declaration": {
          begin: "(?<type_name>(?:(?:(?:(?<identifier>@?[_A-Za-z][_0-9A-Za-z]*)\\s*\\:\\:\\s*)?(?<name_and_type_args>\\g<identifier>\\s*(?<type_args>\\s*<(?:[^<>]|\\g<type_args>)+>\\s*)?)(?:\\s*\\.\\s*\\g<name_and_type_args>)*)(?:\\s*\\?\\s*)?(?:\\s*\\[(?:\\s*,\\s*)*\\]\\s*)*))\\s+(\\g<identifier>)\\s*(?!=>|==)(?=,|;|=|$)",
          beginCaptures: {
            1: {
              patterns: [{
                include: "#support-type"
        ...
        "for-apex-syntax": {
          ...
          match: "([_.A-Za-z][_.0-9A-Za-z]+)\\s+([_.A-Za-z][_.0-9A-Za-z]*)\\s*(\\:)"
        },
        "for-statement": {
          begin: "(?<!\\.)\\b(for)\\b\\s*(?=\\()",
          beginCaptures: {
        ...
        "implements-class": {
          begin: "(implements)\\b\\s+([_A-Za-z][_0-9A-Za-z]*)",
          beginCaptures: {
            1: {
        ...
        "indexer-declaration": {
          begin: "(?<return_type>(?<type_name>(?:(?:ref\\s+)?(?:(?:(?<identifier>@?[_A-Za-z][_0-9A-Za-z]*)\\s*\\:\\:\\s*)?(?<name_and_type_args>\\g<identifier>\\s*(?<type_args>\\s*<(?:[^<>]|\\g<type_args>)+>\\s*)?)(?:\\s*\\.\\s*\\g<name_and_type_args>)*)(?:\\s*\\?\\s*)?(?:\\s*\\[(?:\\s*,\\s*)*\\]\\s*)*))\\s+)(?<interface_name>\\g<type_name>\\s*\\.\\s*)?(?<indexer_name>this)\\s*(?=\\[)",
          beginCaptures: {
            1: {
              patterns: [{
                include: "#type"
        ...
        "invocation-expression": {
          begin: "(?:(\\??\\.)\\s*)?(@?[_A-Za-z][_0-9A-Za-z]*)\\s*(?<type_args>\\s*<([^<>]|\\g<type_args>)+>\\s*)?\\s*(?=\\()",
          beginCaptures: {
            1: {
              patterns: [{
                include: "#punctuation-accessor"
        ...
        "local-constant-declaration": {
          begin: "(?<const_keyword>\\b(?:const)\\b)\\s*(?<type_name>(?:(?:(?:(?<identifier>@?[_A-Za-z][_0-9A-Za-z]*)\\s*\\:\\:\\s*)?(?<name_and_type_args>\\g<identifier>\\s*(?<type_args>\\s*<(?:[^<>]|\\g<type_args>)+>\\s*)?)(?:\\s*\\.\\s*\\g<name_and_type_args>)*)(?:\\s*\\?\\s*)?(?:\\s*\\[(?:\\s*,\\s*)*\\]\\s*)*))\\s+(\\g<identifier>)\\s*(?=,|;|=)",
          beginCaptures: {
            1: {
        ...
        "local-variable-declaration": {
          begin: "(?:(?:(\\bref)\\s+)?(\\bvar\\b)|(?<type_name>(?:(?:ref\\s+)?(?:(?:(?<identifier>@?[_A-Za-z][_0-9A-Za-z]*)\\s*\\:\\:\\s*)?(?<name_and_type_args>\\g<identifier>\\s*(?<type_args>\\s*<(?:[^<>]|\\g<type_args>)+>\\s*)?)(?:\\s*\\.\\s*\\g<name_and_type_args>)*)(?:\\s*\\?\\s*)?(?:\\s*\\[(?:\\s*,\\s*)*\\]\\s*)*)))\\s+(\\g<identifier>)\\s*(?=,|;|=|\\))",
          beginCaptures: {
            1: {
              name: "storage.modifier.apex"
            },
        ...
        "member-access-expression": {
          patterns: [{
            ...
            match: "(\\??\\.)\\s*(@?[_A-Za-z][_0-9A-Za-z]*)\\s*(?![_0-9A-Za-z]|\\(|(\\?)?\\[|<)"
          }, {
            captures: {
              1: {
                patterns: [{
        ...
        "merge-type-statement": {
          ...
          match: "([_A-Za-z]*)\\b\\s+([_A-Za-z]*)\\b\\s*(\\;)"
        },
        "method-declaration": {
          begin: "(?<return_type>(?<type_name>(?:(?:ref\\s+)?(?:(?:(?<identifier>@?[_A-Za-z][_0-9A-Za-z]*)\\s*\\:\\:\\s*)?(?<name_and_type_args>\\g<identifier>\\s*(?<type_args>\\s*<(?:[^<>]|\\g<type_args>)+>\\s*)?)(?:\\s*\\.\\s*\\g<name_and_type_args>)*)(?:\\s*\\?\\s*)?(?:\\s*\\[(?:\\s*,\\s*)*\\]\\s*)*))\\s+)(?<interface_name>\\g<type_name>\\s*\\.\\s*)?(\\g<identifier>)\\s*(<([^<>]+)>)?\\s*(?=\\()",
          beginCaptures: {
            1: {
              patterns: [{
                include: "#support-type"
        ...
        "object-creation-expression-with-no-parameters": {
          ...
          match: "(delete|insert|undelete|update|upsert)?\\s*(new)\\s+(?<type_name>(?:(?:(?:(?<identifier>@?[_A-Za-z][_0-9A-Za-z]*)\\s*\\:\\:\\s*)?(?<name_and_type_args>\\g<identifier>\\s*(?<type_args>\\s*<(?:[^<>]|\\g<type_args>)+>\\s*)?)(?:\\s*\\.\\s*\\g<name_and_type_args>)*)(?:\\s*\\?\\s*)?(?:\\s*\\[(?:\\s*,\\s*)*\\]\\s*)*))\\s*(?=\\{|$)"
        },
        "object-creation-expression-with-parameters": {
          begin: "(delete|insert|undelete|update|upsert)?\\s*(new)\\s+(?<type_name>(?:(?:(?:(?<identifier>@?[_A-Za-z][_0-9A-Za-z]*)\\s*\\:\\:\\s*)?(?<name_and_type_args>\\g<identifier>\\s*(?<type_args>\\s*<(?:[^<>]|\\g<type_args>)+>\\s*)?)(?:\\s*\\.\\s*\\g<name_and_type_args>)*)(?:\\s*\\?\\s*)?(?:\\s*\\[(?:\\s*,\\s*)*\\]\\s*)*))\\s*(?=\\()",
          beginCaptures: {
            1: {
              name: "support.function.apex"
            },
        ...
        parameter: {
          ...
          match: "(?:(?:\\b(this)\\b)\\s+)?(?<type_name>(?:(?:ref\\s+)?(?:(?:(?<identifier>@?[_A-Za-z][_0-9A-Za-z]*)\\s*\\:\\:\\s*)?(?<name_and_type_args>\\g<identifier>\\s*(?<type_args>\\s*<(?:[^<>]|\\g<type_args>)+>\\s*)?)(?:\\s*\\.\\s*\\g<name_and_type_args>)*)(?:\\s*\\?\\s*)?(?:\\s*\\[(?:\\s*,\\s*)*\\]\\s*)*))\\s+(\\g<identifier>)"
        },
        ...
        "property-declaration": {
          begin: "(?!.*\\b(?:class|interface|enum)\\b)\\s*(?<return_type>(?<type_name>(?:(?:ref\\s+)?(?:(?:(?<identifier>@?[_A-Za-z][_0-9A-Za-z]*)\\s*\\:\\:\\s*)?(?<name_and_type_args>\\g<identifier>\\s*(?<type_args>\\s*<(?:[^<>]|\\g<type_args>)+>\\s*)?)(?:\\s*\\.\\s*\\g<name_and_type_args>)*)(?:\\s*\\?\\s*)?(?:\\s*\\[(?:\\s*,\\s*)*\\]\\s*)*))\\s+)(?<interface_name>\\g<type_name>\\s*\\.\\s*)?(?<property_name>\\g<identifier>)\\s*(?=\\{|=>|$)",
          beginCaptures: {
            1: {
              patterns: [{
                include: "#type"
        ...
        "switch-statement": {
          begin: "(switch)\\b\\s+(on)\\b\\s+(?:([_.?\\'\\(\\)0-9A-Za-z]+)\\s*)?(\\{)",
          beginCaptures: {
            1: {
        ...
        "trigger-declaration": {
          ...
          patterns: [{
            begin: "\\b(trigger)\\b\\s+(@?[_A-Za-z][_0-9A-Za-z]*)\\s*\\b(on)\\b\\s+([_A-Za-z][_0-9A-Za-z]*)\\s*",
            beginCaptures: {
              1: {
        ...
        "when-sobject-statement": {
          begin: "(when)\\b\\s+([_0-9A-Za-z]+)\\s+([_0-9A-Za-z]+)\\s*",
          beginCaptures: {
            1: {
              name: "keyword.control.switch.when.apex"
            },
