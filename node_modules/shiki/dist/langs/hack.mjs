var hack_exports = {};,__export(hack_exports, {
  default: () => hack
});,var lang,
  hack,
  init_hack = __esmMin(() => {
...
- Now matches /**#@+ too - used for docblock templates:
  http://manual.phpdoc.org/HTMLframesConverter/default/phpDocumentor/tutorial_phpDocumentor.howto.pkg.html#basics.docblocktemplate`,
        ...
        constants: {
          patterns: [{
            begin: "(?i)(?=((\\\\[a-z_][a-z_0-9]*\\\\[a-z_][a-z_0-9\\\\]*)|([a-z_][a-z_0-9]*\\\\[a-z_][a-z_0-9\\\\]*))[^a-z_0-9\\\\])",
            end: "(?i)([a-z_][a-z_0-9]*)?(?=[^a-z0-9_\\\\])",
            endCaptures: {
              1: {
...
is generated and the constant is assumed to have the value of its name.`,
        ...
        language: {
          patterns: [{
            ...
            begin: "(?i)^\\s*(?:(module)\\s*)?(type|newtype)\\s+([a-z0-9_]+)",
            beginCaptures: {
              1: {
                name: "storage.modifier.php"
              },
            ...
            patterns: [{
              ...
              match: "(?i)([a-z_\\x{7f}-\\x{10ffff}][a-z0-9_\\x{7f}-\\x{10ffff}]*)((?:\\s*\\|\\s*[a-z_\\x{7f}-\\x{10ffff}][a-z0-9_\\x{7f}-\\x{10ffff}]*)*)\\s*((\\$+)[a-z_\\x{7f}-\\x{10ffff}][a-z0-9_\\x{7f}-\\x{10ffff}]*)"
            }]
          }, {
            ...
            begin: "\\s*((?:(?:final|abstract|public|private|protected|internal|static|async)\\s+)*)(function)(?:\\s+)(?:(__(?:call|construct|destruct|get|set|isset|unset|tostring|clone|set_state|sleep|wakeup|autoload|invoke|callStatic|dispose|disposeAsync)(?=[^a-zA-Z0-9_\\x7f-\\xff]))|(\\w+))",
            beginCaptures: {
              1: {
                patterns: [{
            ...
            begin: "(?i)\\s*(?=[a-z_0-9$\\\\]+(::)(?:([a-z_][a-z_0-9]*)\\s*\\(|((\\$+)[a-z_\\x{7f}-\\x{ff}][a-z0-9_\\x{7f}-\\x{ff}]*)|([a-z_\\x{7f}-\\x{ff}][a-z0-9_\\x{7f}-\\x{ff}]*))?)",
        ...
        "parameter-default-types": {
          patterns: [{
            ...
            begin: "(?i)\\s*(?=[a-z_0-9\\\\]+(::)([a-z_\\x{7f}-\\x{ff}][a-z0-9_\\x{7f}-\\x{ff}]*)?)",
