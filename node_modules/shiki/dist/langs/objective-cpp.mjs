var objective_cpp_exports = {};,__export(objective_cpp_exports, {
  default: () => objectiveCpp
});,var lang,
  objectiveCpp,
  init_objective_cpp = __esmMin(() => {
    lang = Object.freeze({
          ...
          repository: {
            ...
            numbers: {
              ...
              patterns: [{
                ...
                match: "(\\G0[xX])(?:([0-9a-fA-F](?:(?:[0-9a-fA-F]|((?<=[0-9a-fA-F])'(?=[0-9a-fA-F]))))*))?((?:(?<=[0-9a-fA-F])\\.|\\.(?=[0-9a-fA-F])))(?:([0-9a-fA-F](?:(?:[0-9a-fA-F]|((?<=[0-9a-fA-F])'(?=[0-9a-fA-F]))))*))?(?:((?<!')([pP])(\\+)?(\\-)?((?-mix:(?:\\d(?:(?:\\d|(?:(?<=[0-9a-fA-F])'(?=[0-9a-fA-F]))))*)))))?(?:([lLfF](?!\\w)))?(?!(?:['0-9a-zA-Z_\\.']|(?<=[eEpP])[+-]))"
              }, {
                captures: {
                  2: {
                ...
                match: "(\\G(?=[0-9.])(?!0[xXbB]))(?:(\\d(?:(?:\\d|((?<=[0-9a-fA-F])'(?=[0-9a-fA-F]))))*))?((?:(?<=\\d)\\.|\\.(?=\\d)))(?:(\\d(?:(?:\\d|((?<=[0-9a-fA-F])'(?=[0-9a-fA-F]))))*))?(?:((?<!')([eE])(\\+)?(\\-)?((?-mix:(?:\\d(?:(?:\\d|(?:(?<=[0-9a-fA-F])'(?=[0-9a-fA-F]))))*)))))?(?:([lLfF](?!\\w)))?(?!(?:['0-9a-zA-Z_\\.']|(?<=[eEpP])[+-]))"
              }, {
                captures: {
                  1: {
                ...
                match: "(\\G0[xX])([0-9a-fA-F](?:(?:[0-9a-fA-F]|((?<=[0-9a-fA-F])'(?=[0-9a-fA-F]))))*)(?:((?<!')([pP])(\\+)?(\\-)?((?-mix:(?:\\d(?:(?:\\d|(?:(?<=[0-9a-fA-F])'(?=[0-9a-fA-F]))))*)))))?(?:((?:(?:(?:(?:(?:[uU]|[uU]ll?)|[uU]LL?)|ll?[uU]?)|LL?[uU]?)|[fF])(?!\\w)))?(?!(?:['0-9a-zA-Z_\\.']|(?<=[eEpP])[+-]))"
              }, {
                captures: {
                  2: {
                    name: "constant.numeric.decimal.objcpp",
                ...
                match: "(\\G(?=[0-9.])(?!0[xXbB]))(\\d(?:(?:\\d|((?<=[0-9a-fA-F])'(?=[0-9a-fA-F]))))*)(?:((?<!')([eE])(\\+)?(\\-)?((?-mix:(?:\\d(?:(?:\\d|(?:(?<=[0-9a-fA-F])'(?=[0-9a-fA-F]))))*)))))?(?:((?:(?:(?:(?:(?:[uU]|[uU]ll?)|[uU]LL?)|ll?[uU]?)|LL?[uU]?)|[fF])(?!\\w)))?(?!(?:['0-9a-zA-Z_\\.']|(?<=[eEpP])[+-]))"
              }, {
        ...
        cpp_lang_newish: {
          ...
          repository: {
            ...
            number_literal: {
              ...
              match: "((?<!\\w)(?:(?:(?:(0[xX])(?:([0-9a-fA-F](?:(?:(?:[0-9a-fA-F]|((?<!')'(?!')))))*))?((?:(?:(?<=[0-9a-fA-F])\\.|\\.(?=[0-9a-fA-F]))))(?:([0-9a-fA-F](?:(?:(?:[0-9a-fA-F]|((?<!')'(?!')))))*))?(?:([pP])(\\+)?(\\-)?((?:\\d(?:(?:(?:\\d|(?:(?<!')'(?!')))))*)))?|(?:(\\d(?:(?:(?:\\d|((?<!')'(?!')))))*))?((?:(?:(?<=\\d)\\.|\\.(?=\\d))))(?:(\\d(?:(?:(?:\\d|((?<!')'(?!')))))*))?(?:([eE])(\\+)?(\\-)?((?:\\d(?:(?:(?:\\d|(?:(?<!')'(?!')))))*)))?)(?:([lLfF](?!\\w)))?|(?:(?:(?:(?:(?:(0[bB])((?:(?:(?:[01]|((?<!')'(?!')))))+)|(0)((?:(?:(?:[0-7]|((?<!')'(?!')))))+)))|(0[xX])([0-9a-fA-F](?:(?:(?:[0-9a-fA-F]|((?<!')'(?!')))))*)(?:([pP])(\\+)?(\\-)?((?:\\d(?:(?:(?:\\d|(?:(?<!')'(?!')))))*)))?))|(\\d(?:(?:(?:\\d|((?<!')'(?!')))))*)(?:([eE])(\\+)?(\\-)?((?:\\d(?:(?:(?:\\d|(?:(?<!')'(?!')))))*)))?)(?:((?:(?:(?:(?:(?:(?:(?:(?:(?:(?:(?:(?:LL[uU]|ll[uU]))|[uU]LL))|[uU]ll))|ll))|LL))|[uUlL]))(?!\\w)))?))(\\w*))"
            },
            operator_overload: {
