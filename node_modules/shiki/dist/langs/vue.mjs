var vue_exports = {};,__export(vue_exports, {
  default: () => vue
});,var lang,
  vue,
  init_vue = __esmMin(() => {
    ...
    init_markdown_vue();
    init_vue_directives();
    init_vue_interpolations();
    init_vue_sfc_style_variable_injection();
    lang = Object.freeze({
      displayName: "Vue",
      name: "vue",
      patterns: [{
    ...
    }), vue = [...html, ...markdown, ...pug, ...stylus, ...sass, ...css, ...scss, ...less, ...javascript, ...typescript, ...jsx, ...tsx, ...coffee, ...json, ...jsonc, ...json5, ...yaml, ...toml, ...graphql, ...html_derivative, ...markdown_vue, ...vue_directives, ...vue_interpolations, ...vue_sfc_style_variable_injection, lang];
  });