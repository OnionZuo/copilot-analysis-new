var blade_exports = {};,__export(blade_exports, {
  default: () => blade
});,var lang,
  blade,
  init_blade = __esmMin(() => {
      ...
      repository: {
        ...
        blade: {
          patterns: [{
            ...
            begin: "(?<![A-Za-z0-9_@])(@(?i:endphp|endsetup)[\\t ]*)(\\()",
            beginCaptures: {
              1: {
                name: "punctuation.section.embedded.end.php"
              },
            ...
            match: "(?<![A-Za-z0-9_@])@(?:(?i)endphp|endsetup)\\b",
            name: "punctuation.section.embedded.end.php"
          }, {
            begin: "(?<![A-Za-z0-9_@])(@\\w+(?:::w+)?[\\t ]*)(\\()",
            beginCaptures: {
              1: {
        ...
        "function-call": {
          patterns: [{
            begin: "(?i)(\\\\?\\b[a-z_\\x{7f}-\\x{ff}][a-z0-9_\\x{7f}-\\x{ff}]*(?:\\\\[a-z_\\x{7f}-\\x{ff}][a-z0-9_\\x{7f}-\\x{ff}]*)+)\\s*(\\()",
            beginCaptures: {
              1: {
                patterns: [{
                  include: "#namespace"
        ...
        "function-parameters": {
          patterns: [{
            ...
            begin: "(?i)(array)\\s+((&)?\\s*(\\$+)[a-z_\\x{7f}-\\x{ff}][a-z0-9_\\x{7f}-\\x{ff}]*)\\s*(=)\\s*(array)\\s*(\\()",
            beginCaptures: {
              1: {
            ...
            match: "(?i)(array|callable)\\s+((&)?\\s*(\\$+)[a-z_\\x{7f}-\\x{ff}][a-z0-9_\\x{7f}-\\x{ff}]*)(?:\\s*(=)\\s*(?:(null)|(\\[)((?>[^\\[\\]]+|\\[\\g<8>\\])*)(\\])|((?:\\S*?\\(\\))|(?:\\S*?))))?\\s*(?=,|\\)|/[/*]|\\#|$)",
            name: "meta.function.parameter.array.php"
          }, {
            begin: "(?i)(\\\\?(?:[a-z_\\x{7f}-\\x{ff}][a-z0-9_\\x{7f}-\\x{ff}]*\\\\)*)([a-z_\\x{7f}-\\x{ff}][a-z0-9_\\x{7f}-\\x{ff}]*)\\s+((&)?\\s*(\\.\\.\\.)?(\\$+)[a-z_\\x{7f}-\\x{ff}][a-z0-9_\\x{7f}-\\x{ff}]*)",
            beginCaptures: {
              1: {
            ...
            begin: "(?i)((&)?\\s*(\\.\\.\\.)?(\\$+)[a-z_\\x{7f}-\\x{ff}][a-z0-9_\\x{7f}-\\x{ff}]*)\\s*(=)\\s*(?:(\\[)((?>[^\\[\\]]+|\\[\\g<6>\\])*)(\\]))?",
            beginCaptures: {
              1: {
                name: "variable.other.php"
              },
          ...
          patterns: [{
            ...
            patterns: [{
              ...
              patterns: [{
                ...
                match: "(?i)\\b(as)\\s+(final|abstract|public|private|protected|static)\\s+([a-z_\\x{7f}-\\x{ff}][a-z0-9_\\x{7f}-\\x{ff}]*)\\b"
              }, {
                captures: {
                  1: {
                    name: "keyword.other.use-as.php"
                ...
                match: "(?i)\\b(as)\\s+([a-z_\\x{7f}-\\x{ff}][a-z0-9_\\x{7f}-\\x{ff}]*)\\b"
              }, {
                captures: {
                  1: {
            ...
            patterns: [{
              ...
              match: "(?i)([a-z_\\x{7f}-\\x{ff}][a-z0-9_\\x{7f}-\\x{ff}]*)((?:\\s*\\|\\s*[a-z_\\x{7f}-\\x{ff}][a-z0-9_\\x{7f}-\\x{ff}]*)*)\\s*((\\$+)[a-z_\\x{7f}-\\x{ff}][a-z0-9_\\x{7f}-\\x{ff}]*)"
            }]
          }, {
            ...
            begin: "((?:(?:final|abstract|public|private|protected|static)\\s+)*)(function)\\s+(?i:(__(?:call|construct|debugInfo|destruct|get|set|isset|unset|tostring|clone|set_state|sleep|wakeup|autoload|invoke|callStatic))|([a-zA-Z_\\x{7f}-\\x{ff}][a-zA-Z0-9_\\x{7f}-\\x{ff}]*))\\s*(\\()",
            beginCaptures: {
              1: {
                patterns: [{
                  match: "final|abstract|public|private|protected|static",
        ...
        "parameter-default-types": {
          patterns: [{
            ...
            begin: "(?i)(?=[a-z0-9_\\x{7f}-\\x{ff}\\\\]+(::)([a-z_\\x{7f}-\\x{ff}][a-z0-9_\\x{7f}-\\x{ff}]*)?)",
...
|array|resource|void|null|callback|false|true|self)\\b`,
        ...
        "scope-resolution": {
          patterns: [{
            ...
            match: "(?i)(::)\\s*(?:((\\$+)[a-z_\\x{7f}-\\x{ff}][a-z0-9_\\x{7f}-\\x{ff}]*)|([a-z_\\x{7f}-\\x{ff}][a-z0-9_\\x{7f}-\\x{ff}]*))?"
          }]
        },
        ...
        "variable-name": {
          patterns: [{
            ...
            match: "(?i)((\\$)(?<name>[a-z_\\x{7f}-\\x{ff}][a-z0-9_\\x{7f}-\\x{ff}]*))(?:(->)(\\g<name>)|(\\[)(?:(\\d+)|((\\$)\\g<name>)|([a-z_\\x{7f}-\\x{ff}][a-z0-9_\\x{7f}-\\x{ff}]*))(\\]))?"
          }, {
            captures: {
              1: {
                name: "variable.other.php"
    ...
    }), blade = [...html, ...xml, ...sql, ...javascript, ...json, ...css, lang];
  });