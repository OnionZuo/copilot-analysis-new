var d_exports = {};,__export(d_exports, {
  default: () => d
});,var lang,
  d,
  init_d = __esmMin(() => {
    lang = Object.freeze({
      ...
      repository: {
        ...
        "decimal-float": {
          patterns: [{
            match: "\\b((\\.\\d)|(0\\.)|(([1-9]|(0[1-9_]))[0-9_]*\\.))[0-9_]*((e-|E-|e\\+|E\\+|e|E)\\d[0-9_]*)?[LfF]?i?\\b",
        ...
        "hexadecimal-float": {
          patterns: [{
            match: "\\b0[xX][0-9a-fA-F_]*(\\.[0-9a-fA-F_]*)?(p-|P-|p\\+|P\\+|p|P)\\d[0-9_]*[LfF]?i?\\b",
