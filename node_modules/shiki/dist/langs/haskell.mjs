var haskell_exports = {};,__export(haskell_exports, {
  default: () => haskell
});,var lang,
  haskell,
  init_haskell = __esmMin(() => {
    lang = Object.freeze({
      displayName: "Haskell",
      ...
      repository: {
        ...
        float_literals: {
          ...
          match: "\\b(?<!')(?:(\\d[_0-9]*\\.\\d[_0-9]*(?:[eE][-+]?\\d[_0-9]*)?|\\d[_0-9]*[eE][-+]?\\d[_0-9]*)|(0[xX]_*[0-9a-fA-F][_0-9a-fA-F]*\\.[0-9a-fA-F][_0-9a-fA-F]*(?:[pP][-+]?\\d[_0-9]*)?|0[xX]_*[0-9a-fA-F][_0-9a-fA-F]*[pP][-+]?\\d[_0-9]*))\\b(?!')"
        },
        forall: {
          begin: "\\b(?<!')(forall|\u2200)\\b(?!')",
          beginCaptures: {
...
`,
        ...
        integer_literals: {
          ...
          match: "\\b(?<!')(?:(\\d[_0-9]*)|(0[xX]_*[0-9a-fA-F][_0-9a-fA-F]*)|(0[oO]_*[0-7][_0-7]*)|(0[bB]_*[01][_01]*))\\b(?!')"
        },
        keyword: {
          captures: {
            1: {
        ...
        pragma: {
          ...
          patterns: [{
            ...
            begin: "(?i)\\b(?<!')(SPECIALI(?:S|Z)E)(?:\\s*(\\[[^\\[\\]]*\\])?\\s*|\\s+)(instance)\\b(?!')",
            beginCaptures: {
              1: {
                name: "keyword.other.preprocessor.pragma.haskell"
              },
            ...
            begin: "(?i)\\b(?<!')(SPECIALI(?:S|Z)E)\\b(?!')(?:\\s+(INLINE)\\b(?!'))?(?:\\s*(\\[[^\\[\\]]*\\])?)\\s*",
            beginCaptures: {
              1: {
                name: "keyword.other.preprocessor.pragma.haskell"
              },
