var fortran_fixed_form_exports = {};,__export(fortran_fixed_form_exports, {
  default: () => fortranFixedForm
});,var lang,
  fortranFixedForm,
  init_fortran_fixed_form = __esmMin(() => {
    ...
    lang = Object.freeze({
      ...
      aliases: ["f", "for", "f77"]
    }), fortranFixedForm = [...fortran_free_form, lang];
  });