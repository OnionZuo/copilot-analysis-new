var mdx_exports = {};,__export(mdx_exports, {
  default: () => mdx
});,var lang,
  mdx,
  init_mdx = __esmMin(() => {
    lang = Object.freeze({
      ...
      repository: {
        ...
        "extension-mdx-jsx-flow": {
          begin: "(?<=^|\\G|\\>)[\\t ]*(<)(?=(?![\\t\\n\\r ]))(?:\\s*(/))?(?:\\s*(?:(?:((?:[_$A-Za-z][-_$0-9A-Za-z]*))\\s*(:)\\s*((?:[_$A-Za-z][-_$0-9A-Za-z]*)))|((?:(?:[_$A-Za-z][_$0-9A-Za-z]*)(?:\\s*\\.\\s*(?:[_$A-Za-z][-_$0-9A-Za-z]*))+))|((?:[_$A-Z][_$0-9A-Za-z]*))|((?:[_$A-Za-z][-_$0-9A-Za-z]*)))(?=[\\s\\/\\>\\{]))?",
          beginCaptures: {
            1: {
