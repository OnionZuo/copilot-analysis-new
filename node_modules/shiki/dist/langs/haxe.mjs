var haxe_exports = {};,__export(haxe_exports, {
  default: () => haxe
});,var lang,
  haxe,
  init_haxe = __esmMin(() => {
      ...
      repository: {
        ...
        "conditional-compilation": {
          patterns: [{
            ...
            match: "((#(if|elseif))[\\s!]+([a-zA-Z_]\\w*(\\.[a-zA-Z_]\\w*)*)(?=\\s|/\\*|//))"
          }, {
            begin: "((#(if|elseif))[\\s!]*)(?=\\()",
            beginCaptures: {
              0: {
        ...
        constants: {
          patterns: [{
            ...
            match: "\\b(?:0[xX][0-9a-fA-F][_0-9a-fA-F]*([iu]\\d[0-9_]*)?)\\b"
          }, {
            captures: {
              0: {
            ...
            match: "\\b(?:0[bB][01][_01]*([iu]\\d[0-9_]*)?)\\b"
          }, {
            captures: {
              0: {
            ...
            match: "(?<!\\$)(?:(?:\\b\\d[0-9_]*(\\.)[0-9_]+[eE][+-]?[0-9_]+([fiu]\\d[0-9_]*)?\\b)|(?:\\b\\d[0-9_]*(\\.)[eE][+-]?[0-9_]+([fiu]\\d[0-9_]*)?\\b)|(?:\\B(\\.)\\d[0-9_]*[eE][+-]?[0-9_]+([fiu]\\d[0-9_]*)?\\b)|(?:\\b\\d[0-9_]*[eE][+-]?\\d[0-9_]*([fiu]\\d[0-9_]*)?\\b)|(?:\\b\\d[0-9_]*(\\.)[0-9_]+([fiu]\\d[0-9_]*)?\\b)|(?:\\b\\d[0-9_]*(\\.)(?!\\.)(?:\\B|([fiu]\\d[0-9_]*)\\b))|(?:\\B(\\.)\\d[0-9_]*([fiu]\\d[0-9_]*)?\\b)|(?:\\b\\d[0-9_]*([fiu]\\d[0-9_]*)?\\b))(?!\\$)"
          }]
        },
        enum: {
          begin: "(?=enum\\s+[A-Z])",
