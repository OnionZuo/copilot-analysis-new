var html_exports = {};,__export(html_exports, {
  default: () => html
});,var lang,
  html,
  init_html = __esmMin(() => {
            ...
            patterns: [{
              ...
              patterns: [{
                ...
                patterns: [{
                  ...
                  begin: "\\G",
                  end: `(?i:(?=>|type(?=[\\s=])(?!\\s*=\\s*(''|""|('|"|)(text/(javascript(1\\.[0-5])?|x-javascript|jscript|livescript|(x-)?ecmascript|babel)|application/((x-)?javascript|(x-)?ecmascript)|module)[\\s"'>]))))`,
                  name: "meta.tag.metadata.script.start.html",
                  patterns: [{
                    include: "#attribute"
                  }]
