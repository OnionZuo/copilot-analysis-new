var php_exports = {};,__export(php_exports, {
  default: () => php
});,var lang,
  php,
  init_php = __esmMin(() => {
      ...
      patterns: [{
        ...
        patterns: [{
          ...
          patterns: [{
            ...
            match: "(?i)\\b(as)\\s+(final|abstract|public|private|protected|static)\\s+([a-z_\\x{7f}-\\x{10ffff}][a-z0-9_\\x{7f}-\\x{10ffff}]*)"
          }, {
            captures: {
              1: {
                name: "keyword.other.use-as.php"
            ...
            match: "(?i)\\b(as)\\s+([a-z_\\x{7f}-\\x{10ffff}][a-z0-9_\\x{7f}-\\x{10ffff}]*)"
          }, {
            captures: {
              1: {
        ...
        begin: "(?i)\\b(trait)\\s+([a-z_\\x{7f}-\\x{10ffff}][a-z0-9_\\x{7f}-\\x{10ffff}]*)",
        beginCaptures: {
          1: {
        ...
        begin: "(?i)\\b(interface)\\s+([a-z_\\x{7f}-\\x{10ffff}][a-z0-9_\\x{7f}-\\x{10ffff}]*)",
        beginCaptures: {
          1: {
        ...
        begin: "(?i)\\b(enum)\\s+([a-z_\\x{7f}-\\x{10ffff}][a-z0-9_\\x{7f}-\\x{10ffff}]*)(?:\\s*(:)\\s*(int|string)\\b)?",
        beginCaptures: {
          1: {
        ...
        begin: "(?i)(?:\\b((?:(?:final|abstract|readonly)\\s+)*)(class)\\s+([a-z_\\x{7f}-\\x{10ffff}][a-z0-9_\\x{7f}-\\x{10ffff}]*)|\\b(new)\\b\\s*(\\#\\[.*\\])?\\s*(?:(readonly)\\s+)?\\b(class)\\b)",
        beginCaptures: {
          1: {
            patterns: [{
...
(?![a-z0-9_\\x{7f}-\\x{10ffff}\\\\])`,
          ...
          match: "(?i)([a-z0-9_\\x{7f}-\\x{10ffff}\\\\]+(?:\\s*\\|\\s*[a-z0-9_\\x{7f}-\\x{10ffff}\\\\]+)*)\\s*((\\$+)[a-z_\\x{7f}-\\x{10ffff}][a-z0-9_\\x{7f}-\\x{10ffff}]*)?"
        }]
      }, {
        ...
        patterns: [{
          ...
          match: "(?i)(:)\\s*((?:\\?\\s*)?[a-z0-9_\\x{7f}-\\x{10ffff}\\\\]+|(?:[a-z0-9_\\x{7f}-\\x{10ffff}\\\\]+|\\(\\s*[a-z0-9_\\x{7f}-\\x{10ffff}\\\\]+(?:\\s*&\\s*[a-z0-9_\\x{7f}-\\x{10ffff}\\\\]+)+\\s*\\))(?:\\s*[|&]\\s*(?:[a-z0-9_\\x{7f}-\\x{10ffff}\\\\]+|\\(\\s*[a-z0-9_\\x{7f}-\\x{10ffff}\\\\]+(?:\\s*&\\s*[a-z0-9_\\x{7f}-\\x{10ffff}\\\\]+)+\\s*\\)))+)(?=\\s*(?:{|/[/*]|\\#|$))"
        }]
      }, {
        begin: "(?i)\\b(fn)\\s*(?=&?\\s*\\()",
        beginCaptures: {
        ...
        contentName: "meta.function.parameters.php",
        end: "(?i)(\\))\\s*(:\\s*(?:\\?\\s*)?(?!\\s)[a-z0-9_\\x{7f}-\\x{10ffff}\\\\\\s\\|&()]+(?<!\\s))?(?=\\s*(?:{|/[/*]|\\#|$|;))",
        endCaptures: {
          1: {
            name: "punctuation.definition.parameters.end.bracket.round.php"
          },
        ...
        patterns: [{
          ...
          begin: "(?i)((?:(?:public|private|protected|readonly)(?:\\s+|(?=\\?)))++)(?:((?:\\?\\s*)?[a-z0-9_\\x{7f}-\\x{10ffff}\\\\]+|(?:[a-z0-9_\\x{7f}-\\x{10ffff}\\\\]+|\\(\\s*[a-z0-9_\\x{7f}-\\x{10ffff}\\\\]+(?:\\s*&\\s*[a-z0-9_\\x{7f}-\\x{10ffff}\\\\]+)+\\s*\\))(?:\\s*[|&]\\s*(?:[a-z0-9_\\x{7f}-\\x{10ffff}\\\\]+|\\(\\s*[a-z0-9_\\x{7f}-\\x{10ffff}\\\\]+(?:\\s*&\\s*[a-z0-9_\\x{7f}-\\x{10ffff}\\\\]+)+\\s*\\)))+)\\s+)?((?:(&)\\s*)?(\\$)[a-z_\\x{7f}-\\x{10ffff}][a-z0-9_\\x{7f}-\\x{10ffff}]*)",
          beginCaptures: {
            1: {
              patterns: [{
        ...
        begin: "((?:(?:final|abstract|public|private|protected|static)\\s+)*)(function)\\s+(?i:(__(?:call|construct|debugInfo|destruct|get|set|isset|unset|toString|clone|set_state|sleep|wakeup|autoload|invoke|callStatic|serialize|unserialize))|(?:(&)?\\s*([a-zA-Z_\\x{7f}-\\x{10ffff}][a-zA-Z0-9_\\x{7f}-\\x{10ffff}]*)))\\s*(\\()",
        beginCaptures: {
          1: {
            patterns: [{
              match: "final|abstract|public|private|protected|static",
        ...
        contentName: "meta.function.parameters.php",
        end: "(?i)(\\))(?:\\s*(:)\\s*((?:\\?\\s*)?[a-z0-9_\\x{7f}-\\x{10ffff}\\\\]+|(?:[a-z0-9_\\x{7f}-\\x{10ffff}\\\\]+|\\(\\s*[a-z0-9_\\x{7f}-\\x{10ffff}\\\\]+(?:\\s*&\\s*[a-z0-9_\\x{7f}-\\x{10ffff}\\\\]+)+\\s*\\))(?:\\s*[|&]\\s*(?:[a-z0-9_\\x{7f}-\\x{10ffff}\\\\]+|\\(\\s*[a-z0-9_\\x{7f}-\\x{10ffff}\\\\]+(?:\\s*&\\s*[a-z0-9_\\x{7f}-\\x{10ffff}\\\\]+)+\\s*\\)))+))?(?=\\s*(?:{|/[/*]|\\#|$|;))",
        endCaptures: {
          1: {
            name: "punctuation.definition.parameters.end.bracket.round.php"
          },
        ...
        match: "(?i)((?:(?:public|private|protected|static|readonly)(?:\\s+|(?=\\?)))++)((?:\\?\\s*)?[a-z0-9_\\x{7f}-\\x{10ffff}\\\\]+|(?:[a-z0-9_\\x{7f}-\\x{10ffff}\\\\]+|\\(\\s*[a-z0-9_\\x{7f}-\\x{10ffff}\\\\]+(?:\\s*&\\s*[a-z0-9_\\x{7f}-\\x{10ffff}\\\\]+)+\\s*\\))(?:\\s*[|&]\\s*(?:[a-z0-9_\\x{7f}-\\x{10ffff}\\\\]+|\\(\\s*[a-z0-9_\\x{7f}-\\x{10ffff}\\\\]+(?:\\s*&\\s*[a-z0-9_\\x{7f}-\\x{10ffff}\\\\]+)+\\s*\\)))+)?\\s+((\\$)[a-z_\\x{7f}-\\x{10ffff}][a-z0-9_\\x{7f}-\\x{10ffff}]*)"
      }, {
        include: "#invoke-call"
      }, {
        include: "#scope-resolution"
      ...
      repository: {
        ...
        "attribute-name": {
          patterns: [{
            ...
            match: "(?i)(\\\\)?\\b(Attribute|SensitiveParameter|AllowDynamicProperties|ReturnTypeWillChange)\\b",
        ...
        "function-call": {
          patterns: [{
            begin: "(\\\\?(?<![a-zA-Z0-9_\\x{7f}-\\x{10ffff}])[a-zA-Z_\\x{7f}-\\x{10ffff}][a-zA-Z0-9_\\x{7f}-\\x{10ffff}]*(?:\\\\[a-zA-Z_\\x{7f}-\\x{10ffff}][a-zA-Z0-9_\\x{7f}-\\x{10ffff}]*)+)\\s*(\\()",
            beginCaptures: {
              1: {
                patterns: [{
                  include: "#namespace"
        ...
        "function-parameters": {
          patterns: [{
            ...
            match: "(?i)(?:((?:\\?\\s*)?[a-z0-9_\\x{7f}-\\x{10ffff}\\\\]+|(?:[a-z0-9_\\x{7f}-\\x{10ffff}\\\\]+|\\(\\s*[a-z0-9_\\x{7f}-\\x{10ffff}\\\\]+(?:\\s*&\\s*[a-z0-9_\\x{7f}-\\x{10ffff}\\\\]+)+\\s*\\))(?:\\s*[|&]\\s*(?:[a-z0-9_\\x{7f}-\\x{10ffff}\\\\]+|\\(\\s*[a-z0-9_\\x{7f}-\\x{10ffff}\\\\]+(?:\\s*&\\s*[a-z0-9_\\x{7f}-\\x{10ffff}\\\\]+)+\\s*\\)))+)\\s+)?((?:(&)\\s*)?(\\.\\.\\.)(\\$)[a-z_\\x{7f}-\\x{10ffff}][a-z0-9_\\x{7f}-\\x{10ffff}]*)(?=\\s*(?:,|\\)|/[/*]|\\#|$))",
            name: "meta.function.parameter.variadic.php"
          }, {
            begin: "(?i)((?:\\?\\s*)?[a-z0-9_\\x{7f}-\\x{10ffff}\\\\]+|(?:[a-z0-9_\\x{7f}-\\x{10ffff}\\\\]+|\\(\\s*[a-z0-9_\\x{7f}-\\x{10ffff}\\\\]+(?:\\s*&\\s*[a-z0-9_\\x{7f}-\\x{10ffff}\\\\]+)+\\s*\\))(?:\\s*[|&]\\s*(?:[a-z0-9_\\x{7f}-\\x{10ffff}\\\\]+|\\(\\s*[a-z0-9_\\x{7f}-\\x{10ffff}\\\\]+(?:\\s*&\\s*[a-z0-9_\\x{7f}-\\x{10ffff}\\\\]+)+\\s*\\)))+)\\s+((?:(&)\\s*)?(\\$)[a-z_\\x{7f}-\\x{10ffff}][a-z0-9_\\x{7f}-\\x{10ffff}]*)",
            beginCaptures: {
              1: {
                patterns: [{
                  include: "#php-types"
            ...
            begin: "(?i)((?:(&)\\s*)?(\\$)[a-z_\\x{7f}-\\x{10ffff}][a-z0-9_\\x{7f}-\\x{10ffff}]*)\\s*(=)\\s*",
            beginCaptures: {
              1: {
                name: "variable.other.php"
              },
        ...
        "parameter-default-types": {
          patterns: [{
            ...
            begin: "(?i)(?=[a-z0-9_\\x{7f}-\\x{10ffff}\\\\]+(::)\\s*([a-z_\\x{7f}-\\x{10ffff}][a-z0-9_\\x{7f}-\\x{10ffff}]*)?)",
...
|array|resource|void|null|callback|false|true|self|static)\\b`,
        ...
        "scope-resolution": {
          patterns: [{
            ...
            match: "(?i)(::)\\s*(?:((\\$+)[a-z_\\x{7f}-\\x{10ffff}][a-z0-9_\\x{7f}-\\x{10ffff}]*)|([a-z_\\x{7f}-\\x{10ffff}][a-z0-9_\\x{7f}-\\x{10ffff}]*))?"
          }]
        },
    ...
    }), php = [...html, ...xml, ...sql, ...javascript, ...json, ...css, lang];
  });