var emacs_lisp_exports = {};,__export(emacs_lisp_exports, {
  default: () => emacsLisp
});,var lang,
  emacsLisp,
  init_emacs_lisp = __esmMin(() => {
    lang = Object.freeze({
      displayName: "Emacs Lisp",
      fileTypes: ["el", "elc", "eld", "spacemacs", "_emacs", "emacs", "emacs.desktop", "abbrev_defs", "Project.ede", "Cask", "gnus", "viper"],
      firstLineMatch: `(?x)
# Hashbang
^\\#!.*(?:\\s|\\/|(?<=!)\\b)
	emacs
	...
	(?=$|\\s|:)
      ...
      repository: {
        "archive-sources": {
          ...
          match: "\\b(?<=[\\s()\\[]|^)(SC|gnu|marmalade|melpa-stable|melpa|org)(?=[\\s()]|$)\\b"
        },
        "arg-values": {
          patterns: [{
        ...
        autoload: {
          ...
          beginCaptures: {
            ...
            2: {
              name: "storage.modifier.autoload.emacs.lisp"
            }
          },
        ...
        definition: {
          patterns: [{
            ...
            begin: "(?<=\\s|^)(\\()(def(advice|class|const|custom|face|image|group|package|struct|subst|theme|type|var))(?:\\s+([-+=*/\\w~!@$%^&:<>{}?]+))?(?=[\\s()]|$)",
            beginCaptures: {
              1: {
                name: "punctuation.section.expression.begin.emacs.lisp"
              },
        ...
        dockey: {
          captures: {
            1: {
              name: "punctuation.definition.reference.begin.emacs.lisp"
            },
            2: {
              name: "constant.other.reference.link.emacs.lisp"
            },
            3: {
              name: "punctuation.definition.reference.end.emacs.lisp"
            }
          },
          match: "(\\x5C{2}\\[)((?:[^\\s\\\\]|\\\\.)+)(\\])",
        ...
        docmap: {
          patterns: [{
            captures: {
              ...
              2: {
                name: "entity.name.tag.keymap.emacs.lisp"
              },
              3: {
                name: "punctuation.definition.reference.end.emacs.lisp"
              }
        ...
        docvar: {
          captures: {
            1: {
              name: "punctuation.definition.quote.begin.emacs.lisp"
            },
            2: {
              name: "punctuation.definition.quote.end.emacs.lisp"
            }
          },
          match: "(`)[^\\s()]+(')",
        ...
        functions: {
          match: "\\b(?<=[\\s()\\[]|^)(abs|append|apply|assoc|butlast|c[ad]{1,2}r|c[ad]r-safe|consp?|copy-alist|copy-tree|dolist|funcall|last|length|listp?|load|make-list|mapc|mapcar|max|min|member|nbutlast|nconc|nreverse|nth|nthcdr|null|pop|prin[1ct]|push|quote|rassoc|reverse|rplac[ad]|safe-length|setcar|setcdr)(?=[\\s()]|$)\\b",
        ...
        "key-notation": {
          patterns: [{
            ...
            match: "\\b((?:[MCSAHs]-)+)(?:(<)(DEL|ESC|LFD|NUL|RET|SPC|TAB)(>)|(DEL|ESC|LFD|NUL|RET|SPC|TAB)\\b|([!-_a-z]{2,})|([!-_a-z]))?",
            name: "meta.key-sequence.emacs.lisp"
          }, {
            captures: {
              1: {
        ...
        operators: {
          patterns: [{
            match: "(?<=[()]|^)(and|catch|cond|condition-case(?:-unless-debug)?|dotimes|eql?|equal|if|not|or|pcase|prog[12n]|throw|unless|unwind-protect|when|while)(?=[\\s()]|$)",
