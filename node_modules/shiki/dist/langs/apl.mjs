var apl_exports = {};,__export(apl_exports, {
  default: () => apl
});,var lang,
  apl,
  init_apl = __esmMin(() => {
...
(?i:
	...
	(?=\\s|:|$)
      ...
      repository: {
        class: {
          patterns: [{
            begin: "(?<=\\s|^)((:)Class)\\s+('[^']*'?|[A-Z_a-z\xC0-\xD6\xD8-\xDD\xDF\xE0-\xF6\xF8-\xFC\xFE\u2206\u2359\u24B6-\u24CF][A-Z_a-z\xC0-\xD6\xD8-\xDD\xDF\xE0-\xF6\xF8-\xFC\xFE\u2206\u2359\u24B6-\u24CF\xAF0-9]*)\\s*((:)\\s*(?:('[^']*'?|[A-Z_a-z\xC0-\xD6\xD8-\xDD\xDF\xE0-\xF6\xF8-\xFC\xFE\u2206\u2359\u24B6-\u24CF][A-Z_a-z\xC0-\xD6\xD8-\xDD\xDF\xE0-\xF6\xF8-\xFC\xFE\u2206\u2359\u24B6-\u24CF\xAF0-9]*)\\s*)?)?(.*?)$",
            beginCaptures: {
              0: {
                name: "meta.class.apl"
              },
            ...
            patterns: [{
              ...
              patterns: [{
                ...
                match: "('[^']*'?|[A-Z_a-z\xC0-\xD6\xD8-\xDD\xDF\xE0-\xF6\xF8-\xFC\xFE\u2206\u2359\u24B6-\u24CF][A-Z_a-z\xC0-\xD6\xD8-\xDD\xDF\xE0-\xF6\xF8-\xFC\xFE\u2206\u2359\u24B6-\u24CF\xAF0-9]*)",
        ...
        "command-switches": {
          patterns: [{
            begin: "(?<=\\s)(-)([A-Z_a-z\xC0-\xD6\xD8-\xDD\xDF\xE0-\xF6\xF8-\xFC\xFE\u2206\u2359\u24B6-\u24CF][A-Z_a-z\xC0-\xD6\xD8-\xDD\xDF\xE0-\xF6\xF8-\xFC\xFE\u2206\u2359\u24B6-\u24CF\xAF0-9]*)(=)",
            beginCaptures: {
              1: {
            ...
            match: "(?<=\\s)(-)([A-Z_a-z\xC0-\xD6\xD8-\xDD\xDF\xE0-\xF6\xF8-\xFC\xFE\u2206\u2359\u24B6-\u24CF][A-Z_a-z\xC0-\xD6\xD8-\xDD\xDF\xE0-\xF6\xF8-\xFC\xFE\u2206\u2359\u24B6-\u24CF\xAF0-9]*)(?!=)",
            name: "variable.parameter.switch.apl"
          }]
        },
        comment: {
        ...
        definition: {
          patterns: [{
            ...
            patterns: [{
              ...
              match: "^\\s*((?>;(?:\\s*[\u2395A-Z_a-z\xC0-\xD6\xD8-\xDD\xDF\xE0-\xF6\xF8-\xFC\xFE\u2206\u2359\u24B6-\u24CF][A-Z_a-z\xC0-\xD6\xD8-\xDD\xDF\xE0-\xF6\xF8-\xFC\xFE\u2206\u2359\u24B6-\u24CF\xAF0-9]*\\s*)+)+)",
              name: "entity.function.definition.apl"
            }, {
              include: "$self"
            }]
        ...
        number: {
          patterns: [{
            match: "\xAF?\\d[\xAF0-9A-Za-z]*(?:\\.[\xAF0-9Ee][\xAF0-9A-Za-z]*)*|\xAF?\\.[0-9Ee][\xAF0-9A-Za-z]*",
    ...
    }), apl = [...html, ...xml, ...css, ...javascript, ...json, lang];
  });