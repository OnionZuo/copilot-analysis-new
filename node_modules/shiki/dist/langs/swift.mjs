var swift_exports = {};,__export(swift_exports, {
  default: () => swift
});,var lang,
  swift,
  init_swift = __esmMin(() => {
      ...
      repository: {
        ...
        attributes: {
          patterns: [{
            ...
            patterns: [{
              ...
              match: "\\b(swift|(?:iOS|macOS|OSX|watchOS|tvOS|visionOS|UIKitForMac)(?:ApplicationExtension)?)\\b(?:\\s+(\\d+(?:\\.\\d+)*\\b))?"
            }, {
        ...
        "expressions-without-trailing-closures-or-member-references-availability-condition": {
          ...
          patterns: [{
            ...
            match: "\\s*\\b((?:iOS|macOS|OSX|watchOS|tvOS|visionOS|UIKitForMac)(?:ApplicationExtension)?)\\b(?:\\s+(\\d+(?:\\.\\d+)*\\b))"
          }, {
            captures: {
              1: {
                name: "keyword.other.platform.all.swift"
        ...
        "literals-numeric": {
          patterns: [{
            ...
            match: "(?<=[\\[\\](){}\\p{L}_\\p{N}\\p{M}]\\.)\\d+\\b"
          }, {
            comment: "0b010, 0b1_0",
            match: "(\\B\\-|\\b)(?<![\\[\\](){}\\p{L}_\\p{N}\\p{M}]\\.)0b[01][01_]*\\b(?!\\.\\d)",
            name: "constant.numeric.integer.binary.swift"
          }, {
            comment: "0o1, 0o7_3",
            match: "(\\B\\-|\\b)(?<![\\[\\](){}\\p{L}_\\p{N}\\p{M}]\\.)0o[0-7][0-7_]*\\b(?!\\.\\d)",
            name: "constant.numeric.integer.octal.swift"
          }, {
            comment: "02, 3_456",
            match: "(\\B\\-|\\b)(?<![\\[\\](){}\\p{L}_\\p{N}\\p{M}]\\.)\\d[0-9_]*\\b(?!\\.\\d)",
            name: "constant.numeric.integer.decimal.swift"
          }, {
            comment: "0x4, 0xF_7",
            match: "(\\B\\-|\\b)(?<![\\[\\](){}\\p{L}_\\p{N}\\p{M}]\\.)0x[0-9a-fA-F][0-9a-fA-F_]*\\b(?!\\.\\d)",
