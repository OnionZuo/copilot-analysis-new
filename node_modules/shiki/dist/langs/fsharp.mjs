var fsharp_exports = {};,__export(fsharp_exports, {
  default: () => fsharp
});,var lang,
  fsharp,
  init_fsharp = __esmMin(() => {
    init_markdown();
    lang = Object.freeze({
      displayName: "F#",
      name: "fsharp",
      ...
      repository: {
        abstract_definition: {
          ...
          patterns: [{
            ...
            match: "(\\?{0,1})([A-Za-z0-9'`^._ ]+)\\s*(:)((?!with\\b)\\b([\\w0-9'`^._ ]+)){0,1}"
          }, {
            captures: {
              1: {
                name: "entity.name.type.fsharp"
        ...
        common_declaration: {
          patterns: [{
            ...
            begin: "(\\?{0,1})([A-Za-z0-9'`^._ ]+)\\s*(:)(\\s*([?A-Za-z0-9'`^._ ]+)(<))",
            beginCaptures: {
              1: {
                name: "keyword.symbol.fsharp"
              },
        ...
        constants: {
          patterns: [{
            ...
            match: "\\b-?\\d[0-9_]*((\\.(?!\\.)(\\d[0-9_]*([eE][+-]??\\d[0-9_]*)?)?)|([eE][+-]??\\d[0-9_]*))",
            name: "constant.numeric.float.fsharp"
          }, {
            match: "\\b(-?((0(x|X)[0-9a-fA-F][0-9a-fA-F_]*)|(0(o|O)[0-7][0-7_]*)|(0(b|B)[01][01_]*)|(\\d[0-9_]*)))",
        ...
        definition: {
          patterns: [{
            ...
            begin: "\\b(use|use!|and|and!)\\s+(\\[[^-=]*\\]|[_A-Za-z]([_A-Za-z0-9\\._]+)*|``[_A-Za-z]([_A-Za-z0-9\\._`\\s]+|(?<=,)\\s)*)?",
            beginCaptures: {
              1: {
                name: "keyword.fsharp"
              }
            ...
            begin: "(?<=with|and)\\s*\\b((get|set)\\s*(?=\\())(\\[[^-=]*\\]|[_A-Za-z]([_A-Za-z0-9\\._]+)*|``[_A-Za-z]([_A-Za-z0-9\\._`\\s]+|(?<=,)\\s)*)?",
            beginCaptures: {
              4: {
                name: "variable.fsharp"
              }
            ...
            begin: "\\b(static val mutable|val mutable|val inline|val)(\\s+rec|mutable)?(\\s+\\[\\<.*\\>\\])?\\s*(private|internal|public)?\\s+(\\[[^-=]*\\]|[_A-Za-z]([_A-Za-z0-9,\\._]+)*|``[_A-Za-z]([_A-Za-z0-9,\\._`\\s]+|(?<=,)\\s)*)?",
            beginCaptures: {
              1: {
                name: "keyword.fsharp"
              },
        ...
        du_declaration: {
          patterns: [{
            ...
            patterns: [{
              ...
              match: "([A-Za-z0-9'`<>^._]+|``[A-Za-z0-9' <>^._]+``)\\s*(:)\\s*([A-Za-z0-9'`<>^._]+|``[A-Za-z0-9' <>^._]+``)"
            }, {
              captures: {
                1: {
                  name: "entity.name.type.fsharp"
        ...
        member_declaration: {
          patterns: [{
            ...
            match: "(\\?{0,1})([A-Za-z0-9'`^._]+|``[A-Za-z0-9'`^:,._ ]+``)\\s*(:{0,1})(\\s*([?A-Za-z0-9'`<>._ ]+)){0,1}"
          }, {
            include: "#keywords"
          }]
        },
        modules: {
          patterns: [{
            begin: "\\b(namespace global)|\\b(namespace|module)\\s*(public|internal|private|rec)?\\s+([A-Za-z|``][A-Za-z0-9'_. ]*)",
            beginCaptures: {
              1: {
                name: "keyword.fsharp"
              },
            ...
            begin: "\\b(open type|open)\\s+([A-Za-z|``][A-Za-z0-9'_]*)(?=(\\.[A-Z][A-Za-z0-9_]*)*)",
            beginCaptures: {
              1: {
                name: "keyword.fsharp"
              },
        ...
        record_declaration: {
          patterns: [{
            ...
            patterns: [{
              ...
              begin: "(((mutable)\\s[A-Za-z]+)|[A-Za-z0-9'`<>^._]*)\\s*((?<!:):(?!:))\\s*",
              beginCaptures: {
                3: {
                  name: "keyword.fsharp"
                },
        ...
        strings: {
          patterns: [{
            ...
            patterns: [{
              ...
              match: `\\\\(['"\\\\abfnrtv]|([01]\\d\\d|2[0-4]\\d|25[0-5])|(x[0-9a-fA-F]{2})|(u[0-9a-fA-F]{4})|(U00(0[0-9a-fA-F]|10)[0-9a-fA-F]{4}))`,
              name: "constant.character.string.escape.fsharp"
            }, {
              match: "\\\\((\\d{1,3})|(x[^\\s]{0,2})|(u[^\\s]{0,4})|(U[^\\s]{0,8})|[^\\s])",
        ...
        strp_inlined_body: {
          patterns: [{
            ...
            match: "(static member|member)\\s*([A-Za-z0-9'`<>^._]+|``[A-Za-z0-9' <>^._]+``)\\s*(:)"
          }, {
            include: "#compiler_directives"
          }, {
            include: "#constants"
        ...
        variables: {
          patterns: [{
            ...
            match: "(\\?{0,1})(``[A-Za-z0-9'`^:,._ ]+``|(?!private|struct\\b)\\b[\\wA-Za-z0-9'`<>^._ ]+)"
          }]
        }
      },
