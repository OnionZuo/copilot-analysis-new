var common_lisp_exports = {};,__export(common_lisp_exports, {
  default: () => commonLisp
});,var lang,
  commonLisp,
  init_common_lisp = __esmMin(() => {
    lang = Object.freeze({
      ...
      repository: {
        ...
        constant: {
          patterns: [{
            ...
            match: "(?<=^|\\s|\\(|,@|,\\.|,)([+-]?\\d+(?:\\/\\d+)*|[-+]?\\d*\\.?\\d+([eE][-+]?\\d+)?|(\\#b|\\#B)[01\\/+-]+|(\\#o|\\#O)[0-7\\/+-]+|(\\#x|\\#X)[0-9a-fA-F\\/+-]+|(\\#\\d+[rR]?)[0-9a-zA-Z\\/+-]+)(?=(\\s|\\)))",
            name: "constant.numeric.commonlisp"
          }, {
            match: "(?i)(?<=\\s)(\\.)(?=\\s)",
            name: "variable.other.constant.dot.commonlisp"
          }, {
            match: "(?<=^|\\s|\\(|,@|,\\.|,)([+-]?\\d*\\.\\d*((e|s|f|d|l|E|S|F|D|L)[+-]?\\d+)?|[+-]?\\d+(\\.\\d*)?(e|s|f|d|l|E|S|F|D|L)[+-]?\\d+)(?=(\\s|\\)))",
            name: "constant.numeric.commonlisp"
          }]
        },
        declaration: {
        ...
        "def-name": {
          patterns: [{
            ...
            match: "(?i)(?<=^|\\s|\\()(defun|defsetf|defmethod|defmacro|define-symbol-macro|define-setf-expander|define-modify-macro|define-method-combination|define-compiler-macro|defgeneric)\\s+(\\(\\s*([#:A-Za-z0-9\\+\\-\\*\\/\\@\\$\\%\\^\\&\\_\\=\\<\\>\\~\\!\\?\\[\\]\\{\\}\\.]+)\\s*((,@|,\\.|,)?)([#:A-Za-z0-9\\+\\-\\*\\/\\@\\$\\%\\^\\&\\_\\=\\<\\>\\~\\!\\?\\[\\]\\{\\}\\.]+?)|((,@|,\\.|,)?)([#:A-Za-z0-9\\+\\-\\*\\/\\@\\$\\%\\^\\&\\_\\=\\<\\>\\~\\!\\?\\[\\]\\{\\}\\.]+?))(?=(\\s|\\(|\\)))"
          }, {
            captures: {
              1: {
                name: "storage.type.function.defname.commonlisp"
            ...
            match: "(?i)(?<=^|\\s|\\()(deftype|defpackage|define-condition|defclass)\\s+([#:A-Za-z0-9\\+\\-\\*\\/\\@\\$\\%\\^\\&\\_\\=\\<\\>\\~\\!\\?\\[\\]\\{\\}\\.]+?)(?=(\\s|\\(|\\)))"
          }, {
            captures: {
              1: {
                name: "storage.type.function.defname.commonlisp"
            ...
            match: "(?i)(?<=^|\\s|\\()(defvar|defparameter)\\s+(?=(\\s|\\(|\\)))"
          }, {
            captures: {
              1: {
                name: "storage.type.function.defname.commonlisp"
