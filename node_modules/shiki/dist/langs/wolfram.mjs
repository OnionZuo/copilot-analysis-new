var wolfram_exports = {};,__export(wolfram_exports, {
  default: () => wolfram
});,var lang,
  wolfram,
  init_wolfram = __esmMin(() => {
    lang = Object.freeze({
      displayName: "Wolfram",
      ...
      repository: {
        ...
        "simple-toplevel-definitions": {
          patterns: [{
            ...
            match: "^\\s*(Attributes|Format|Options)\\s*(\\[)(`?(?:(?:[$A-Za-z][$0-9A-Za-z]*)`)*)((?:[$A-Za-z][$0-9A-Za-z]*))(\\])\\s*(:=|=(?!!|=|\\.))"
          }, {
            captures: {
              1: {
                name: "meta.function.wolfram entity.name.Context.wolfram"
            ...
            match: "^\\s*(`?(?:(?:[$A-Za-z][$0-9A-Za-z]*)`)*)((?:[$A-Za-z][$0-9A-Za-z]*))(?=\\s*(\\[(?>[^\\[\\]]+|\\g<-1>)*\\])\\s*(?:/;.*)?(?::=|=(?!!|=|\\.)))"
          }, {
            captures: {
              1: {
                name: "meta.function.wolfram entity.name.Context.wolfram"
        ...
        symbols: {
          patterns: [{
            ...
            match: "System`(?:E(?:ditButtonSettings|liminationOrder|llipticReducedHalfPeriods|mbeddingObject|mphasizeSyntaxErrors|mpty|nableConsolePrintPacket|ndAdd|ngineEnvironment|nter|qualColumns|qualRows|quatedTo|rrorBoxOptions|rrorNorm|rrorPacket|rrorsDialogSettings|valuated|valuationMode|valuationOrder|valuationRateLimit|ventEvaluator|ventHandlerTag|xactRootIsolation|xitDialog|xpectationE|xportPacket|xpressionPacket|xternalCall|xternalFunctionName))(?![`$0-9A-Za-z])",
            name: "support.function.undocumented.wolfram"
          }, {
            ...
            match: "System`(?:W(?:ebAudioSearch|ebColumn|ebElementObject|ebExecute|ebImage|ebImageSearch|ebItem|ebRow|ebSearch|ebSessionObject|ebSessions|ebWindowObject|ikidataData|ikidataSearch|ikipediaSearch|ithCleanup|ithLock))(?![`$0-9A-Za-z])",
            name: "support.function.experimental.wolfram"
          }, {
            match: "System`(?:Z(?:oomCenter|oomFactor))(?![`$0-9A-Za-z])",
            name: "support.function.experimental.wolfram"
          }, {
            match: "System`(?:\\$(?:AllowExternalChannelFunctions|AudioDecoders|AudioEncoders|BlockchainBase|ChannelBase|CompilerEnvironment|CookieStore|CryptographicEllipticCurveNames|CurrentWebSession|DataStructures|DefaultNetworkInterface|DefaultProxyRules|DefaultRemoteBatchSubmissionEnvironment|DefaultRemoteKernel|DefaultSystemCredentialStore|ExternalIdentifierTypes|ExternalStorageBase|GeneratedAssetLocation|IncomingMailSettings|Initialization|InitializationContexts|MaxDisplayedChildren|NetworkInterfaces|NoValue|PersistenceBase|PersistencePath|PreInitialization|PublisherID|ResourceSystemBase|ResourceSystemPath|SSHAuthentication|ServiceCreditsAvailable|SourceLink|SubtitleDecoders|SubtitleEncoders|SystemCredentialStore|TargetSystems|TestFileName|VideoDecoders|VideoEncoders|VoiceStyles))(?![`$0-9A-Za-z])",
            name: "support.function.experimental.wolfram"
          }, {
            match: "System`(?:E(?:cho|xit))(?![`$0-9A-Za-z])",
            name: "invalid.session.wolfram"
          }, {
            match: "System`(?:I(?:n|nString))(?![`$0-9A-Za-z])",
            name: "invalid.session.wolfram"
          }, {
            match: "System`(?:O(?:ut))(?![`$0-9A-Za-z])",
            name: "invalid.session.wolfram"
          }, {
            match: "System`(?:P(?:rint))(?![`$0-9A-Za-z])",
            name: "invalid.session.wolfram"
          }, {
            match: "System`(?:Q(?:uit))(?![`$0-9A-Za-z])",
            name: "invalid.session.wolfram"
          }, {
            match: "System`(?:\\$(?:HistoryLength|Line|Post|Pre|PrePrint|PreRead|SyntaxHandler))(?![`$0-9A-Za-z])",
            name: "invalid.session.wolfram"
          }, {
            match: "System`(?:[$A-Za-z][$0-9A-Za-z]*)(?![`$0-9A-Za-z])",
            name: "invalid.illegal.system.wolfram"
          }, {
            match: "(?:[$A-Za-z][$0-9A-Za-z]*)(?:`(?:[$A-Za-z][$0-9A-Za-z]*))+(?=\\s*(\\[(?!\\s*\\[)|@(?!@)))",
            ...
            match: "(?:X(?:MLElement|MLObject|MLTemplate|YZColor|nor|or))(?![`$0-9A-Za-z])",
            name: "support.function.builtin.wolfram"
          }, {
            match: "(?:Y(?:uleDissimilarity))(?![`$0-9A-Za-z])",
            name: "support.function.builtin.wolfram"
          }, {
            match: "(?:Z(?:IPCodeData|Test|Transform|ernikeR|eroSymmetric|eta|etaZero|ipfDistribution))(?![`$0-9A-Za-z])",
            name: "support.function.builtin.wolfram"
          }, {
            match: "(?:A(?:cceptanceThreshold|ccuracyGoal|ctiveStyle|ddOnHelpPath|djustmentBoxOptions|lignment|lignmentPoint|llowGroupClose|llowInlineCells|llowLooseGrammar|llowReverseGroupClose|llowScriptLevelChange|llowVersionUpdate|llowedCloudExtraParameters|llowedCloudParameterExtensions|llowedDimensions|llowedFrequencyRange|llowedHeads|lternativeHypothesis|ltitudeMethod|mbiguityFunction|natomySkinStyle|nchoredSearch|nimationDirection|nimationRate|nimationRepetitions|nimationRunTime|nimationRunning|nimationTimeIndex|nnotationRules|ntialiasing|ppearance|ppearanceElements|ppearanceRules|spectRatio|ssociationFormat|ssumptions|synchronous|ttachedCell|udioChannelAssignment|udioEncoding|udioInputDevice|udioLabel|udioOutputDevice|uthentication|utoAction|utoCopy|utoDelete|utoGeneratedPackage|utoIndent|utoItalicWords|utoMultiplicationSymbol|utoOpenNotebooks|utoOpenPalettes|utoOperatorRenderings|utoRemove|utoScroll|utoSpacing|utoloadPath|utorunSequencing|xes|xesEdge|xesLabel|xesOrigin|xesStyle))(?![`$0-9A-Za-z])",
            name: "constant.language.wolfram"
          }, {
            match: "(?:B(?:ackground|arOrigin|arSpacing|aseStyle|aselinePosition|inaryFormat|ookmarks|ooleanStrings|oundaryStyle|oxBaselineShift|oxFormFormatTypes|oxFrame|oxMargins|oxRatios|oxStyle|oxed|ubbleScale|ubbleSizes|uttonBoxOptions|uttonData|uttonFunction|uttonMinHeight|uttonSource|yteOrdering))(?![`$0-9A-Za-z])",
            name: "constant.language.wolfram"
          }, {
            ...
            match: "(?:H(?:eaderAlignment|eaderBackground|eaderDisplayFunction|eaderLines|eaderSize|eaderStyle|eads|elpBrowserSettings|iddenItems|olidayCalendar|yperlinkAction|yphenation))(?![`$0-9A-Za-z])",
            name: "constant.language.wolfram"
          }, {
            match: "(?:I(?:conRules|gnoreCase|gnoreDiacritics|gnorePunctuation|mageCaptureFunction|mageFormattingWidth|mageLabels|mageLegends|mageMargins|magePadding|magePreviewFunction|mageRegion|mageResolution|mageSize|mageSizeAction|mageSizeMultipliers|magingDevice|mportAutoReplacements|mportOptions|ncludeConstantBasis|ncludeDefinitions|ncludeDirectories|ncludeFileExtension|ncludeGeneratorTasks|ncludeInflections|ncludeMetaInformation|ncludePods|ncludeQuantities|ncludeSingularSolutions|ncludeWindowTimes|ncludedContexts|ndeterminateThreshold|nflationMethod|nheritScope|nitialSeeding|nitialization|nitializationCell|nitializationCellEvaluation|nitializationCellWarning|nputAliases|nputAssumptions|nputAutoReplacements|nsertResults|nsertionFunction|nteractive|nterleaving|nterpolationOrder|nterpolationPoints|nterpretationBoxOptions|nterpretationFunction|ntervalMarkers|ntervalMarkersStyle|nverseFunctions|temAspectRatio|temDisplayFunction|temSize|temStyle))(?![`$0-9A-Za-z])",
            name: "constant.language.wolfram"
          }, {
            match: "(?:J(?:oined))(?![`$0-9A-Za-z])",
            name: "constant.language.wolfram"
          }, {
            match: "(?:K(?:eepExistingVersion|eyCollisionFunction|eypointStrength))(?![`$0-9A-Za-z])",
            name: "constant.language.wolfram"
          }, {
            ...
            match: "(?:O(?:pacityFunction|pacityFunctionScaling|peratingSystem|ptionInspectorSettings|utputAutoOverwrite|utputSizeLimit|verlaps|verscriptBoxOptions|verwriteTarget))(?![`$0-9A-Za-z])",
            name: "constant.language.wolfram"
          }, {
            match: "(?:P(?:IDDerivativeFilter|IDFeedforward|acletSite|adding|addingSize|ageBreakAbove|ageBreakBelow|ageBreakWithin|ageFooterLines|ageFooters|ageHeaderLines|ageHeaders|ageTheme|ageWidth|alettePath|aneled|aragraphIndent|aragraphSpacing|arallelization|arameterEstimator|artBehavior|artitionGranularity|assEventsDown|assEventsUp|asteBoxFormInlineCells|ath|erformanceGoal|ermissions|haseRange|laceholderReplace|layRange|lotLabel|lotLabels|lotLayout|lotLegends|lotMarkers|lotPoints|lotRange|lotRangeClipping|lotRangePadding|lotRegion|lotStyle|lotTheme|odStates|odWidth|olarAxes|olarAxesOrigin|olarGridLines|olarTicks|oleZeroMarkers|recisionGoal|referencesPath|reprocessingRules|reserveColor|reserveImageOptions|rincipalValue|rintAction|rintPrecision|rintingCopies|rintingOptions|rintingPageRange|rintingStartingPageNumber|rintingStyleEnvironment|rintout3DPreviewer|rivateCellOptions|rivateEvaluationOptions|rivateFontOptions|rivateNotebookOptions|rivatePaths|rocessDirectory|rocessEnvironment|rocessEstimator|rogressReporting|rolog|ropagateAborts))(?![`$0-9A-Za-z])",
            name: "constant.language.wolfram"
          }, {
            match: "(?:Q(?:uartics))(?![`$0-9A-Za-z])",
            name: "constant.language.wolfram"
          }, {
            ...
            match: "(?:U(?:nderoverscriptBoxOptions|nderscriptBoxOptions|ndoOptions|ndoTrackedVariables|nitSystem|nityDimensions|nsavedVariables|pdateInterval|pdatePacletSites|tilityFunction))(?![`$0-9A-Za-z])",
            name: "constant.language.wolfram"
          }, {
            ...
            match: "(?:W(?:aveletScale|eights|hitePoint|indowClickSelect|indowElements|indowFloating|indowFrame|indowFrameElements|indowMargins|indowOpacity|indowSize|indowStatusArea|indowTitle|indowToolbars|ordOrientation|ordSearch|ordSelectionFunction|ordSeparators|ordSpacings|orkingPrecision|rapAround))(?![`$0-9A-Za-z])",
            name: "constant.language.wolfram"
          }, {
            match: "(?:Z(?:eroTest|eroWidthTimes))(?![`$0-9A-Za-z])",
            name: "constant.language.wolfram"
          }, {
            match: "(?:A(?:bove|fter|lgebraics|ll|nonymous|utomatic|xis))(?![`$0-9A-Za-z])",
            name: "constant.language.wolfram"
          }, {
            match: "(?:B(?:ack|ackward|aseline|efore|elow|lack|lue|old|ooleans|ottom|oxes|rown|yte))(?![`$0-9A-Za-z])",
            name: "constant.language.wolfram"
          }, {
            match: "(?:C(?:atalan|ellStyle|enter|haracter|omplexInfinity|omplexes|onstant|yan))(?![`$0-9A-Za-z])",
            name: "constant.language.wolfram"
          }, {
            match: "(?:D(?:ashed|efaultAxesStyle|efaultBaseStyle|efaultBoxStyle|efaultFaceGridsStyle|efaultFieldHintStyle|efaultFrameStyle|efaultFrameTicksStyle|efaultGridLinesStyle|efaultLabelStyle|efaultMenuStyle|efaultTicksStyle|efaultTooltipStyle|egree|elimiter|igitCharacter|otDashed|otted))(?![`$0-9A-Za-z])",
            name: "constant.language.wolfram"
          }, {
            match: "(?:E(?:|ndOfBuffer|ndOfFile|ndOfLine|ndOfString|ulerGamma|xpression))(?![`$0-9A-Za-z])",
            name: "constant.language.wolfram"
          }, {
            match: "(?:F(?:alse|lat|ontProperties|orward|orwardBackward|riday|ront|rontEndDynamicExpression|ull))(?![`$0-9A-Za-z])",
            name: "constant.language.wolfram"
          }, {
            match: "(?:G(?:eneral|laisher|oldenAngle|oldenRatio|ray|reen))(?![`$0-9A-Za-z])",
            name: "constant.language.wolfram"
          }, {
            match: "(?:H(?:ere|exadecimalCharacter|oldAll|oldAllComplete|oldFirst|oldRest))(?![`$0-9A-Za-z])",
            name: "constant.language.wolfram"
          }, {
            match: "(?:I(?:|ndeterminate|nfinity|nherited|nteger|ntegers|talic))(?![`$0-9A-Za-z])",
            name: "constant.language.wolfram"
          }, {
            match: "(?:K(?:hinchin))(?![`$0-9A-Za-z])",
            name: "constant.language.wolfram"
          }, {
            match: "(?:L(?:arge|arger|eft|etterCharacter|ightBlue|ightBrown|ightCyan|ightGray|ightGreen|ightMagenta|ightOrange|ightPink|ightPurple|ightRed|ightYellow|istable|ocked))(?![`$0-9A-Za-z])",
            name: "constant.language.wolfram"
          }, {
            match: "(?:M(?:achinePrecision|agenta|anual|edium|eshCellCentroid|eshCellMeasure|eshCellQuality|onday))(?![`$0-9A-Za-z])",
            name: "constant.language.wolfram"
          }, {
            match: "(?:N(?:HoldAll|HoldFirst|HoldRest|egativeIntegers|egativeRationals|egativeReals|oWhitespace|onNegativeIntegers|onNegativeRationals|onNegativeReals|onPositiveIntegers|onPositiveRationals|onPositiveReals|one|ow|ull|umber|umberString|umericFunction))(?![`$0-9A-Za-z])",
            name: "constant.language.wolfram"
          }, {
            match: "(?:O(?:neIdentity|range|rderless))(?![`$0-9A-Za-z])",
            name: "constant.language.wolfram"
          }, {
            match: "(?:P(?:i|ink|lain|ositiveIntegers|ositiveRationals|ositiveReals|rimes|rotected|unctuationCharacter|urple))(?![`$0-9A-Za-z])",
            name: "constant.language.wolfram"
          }, {
            match: "(?:R(?:ationals|eadProtected|eal|eals|ecord|ed|ight))(?![`$0-9A-Za-z])",
            name: "constant.language.wolfram"
          }, {
            match: "(?:S(?:aturday|equenceHold|mall|maller|panFromAbove|panFromBoth|panFromLeft|tartOfLine|tartOfString|tring|truckthrough|tub|unday))(?![`$0-9A-Za-z])",
            name: "constant.language.wolfram"
          }, {
            match: "(?:T(?:emporary|hick|hin|hursday|iny|oday|omorrow|op|ransparent|rue|uesday))(?![`$0-9A-Za-z])",
            name: "constant.language.wolfram"
          }, {
            match: "(?:U(?:ndefined|nderlined))(?![`$0-9A-Za-z])",
            name: "constant.language.wolfram"
          }, {
            match: "(?:W(?:ednesday|hite|hitespace|hitespaceCharacter|ord|ordBoundary|ordCharacter))(?![`$0-9A-Za-z])",
            name: "constant.language.wolfram"
          }, {
            match: "(?:Y(?:ellow|esterday))(?![`$0-9A-Za-z])",
            name: "constant.language.wolfram"
          }, {
            ...
            match: "(?:A(?:bortScheduledTask|ctive|lgebraicRules|lternateImage|natomyForm|nimationCycleOffset|nimationCycleRepetitions|nimationDisplayTime|spectRatioFixed|stronomicalData|synchronousTaskObject|synchronousTasks|udioDevice|udioLooping))(?![`$0-9A-Za-z])",
            name: "invalid.deprecated.wolfram"
          }, {
            match: "(?:B(?:uttonEvaluator|uttonExpandable|uttonFrame|uttonMargins|uttonNote|uttonStyle))(?![`$0-9A-Za-z])",
            name: "invalid.deprecated.wolfram"
          }, {
            match: "(?:C(?:DFInformation|hebyshevDistance|lassifierInformation|lipFill|olorOutput|olumnForm|ompose|onstantArrayLayer|onstantPlusLayer|onstantTimesLayer|onstrainedMax|onstrainedMin|ontourGraphics|ontourLines|onversionOptions|reateScheduledTask|reateTemporary|urry))(?![`$0-9A-Za-z])",
            name: "invalid.deprecated.wolfram"
          }, {
            match: "(?:D(?:atabinRemove|ate|ebug|efaultColor|efaultFont|ensityGraphics|isplay|isplayString|otPlusLayer|ragAndDrop))(?![`$0-9A-Za-z])",
            name: "invalid.deprecated.wolfram"
          }, {
            match: "(?:E(?:dgeLabeling|dgeRenderingFunction|valuateScheduledTask|xpectedValue))(?![`$0-9A-Za-z])",
            name: "invalid.deprecated.wolfram"
          }, {
            match: "(?:F(?:actorComplete|ontForm|ormTheme|romDate|ullOptions))(?![`$0-9A-Za-z])",
            name: "invalid.deprecated.wolfram"
          }, {
            match: "(?:G(?:raphStyle|raphicsArray|raphicsSpacing|ridBaseline))(?![`$0-9A-Za-z])",
            name: "invalid.deprecated.wolfram"
          }, {
            match: "(?:H(?:TMLSave|eldPart|iddenSurface|omeDirectory))(?![`$0-9A-Za-z])",
            name: "invalid.deprecated.wolfram"
          }, {
            match: "(?:I(?:mageRotated|nstanceNormalizationLayer))(?![`$0-9A-Za-z])",
            name: "invalid.deprecated.wolfram"
          }, {
            match: "(?:L(?:UBackSubstitution|egendreType|ightSources|inearProgramming|inkOpen|iteral|ongestMatch))(?![`$0-9A-Za-z])",
            name: "invalid.deprecated.wolfram"
          }, {
            match: "(?:M(?:eshRange|oleculeEquivalentQ))(?![`$0-9A-Za-z])",
            name: "invalid.deprecated.wolfram"
          }, {
            match: "(?:N(?:etInformation|etSharedArray|extScheduledTaskTime|otebookCreate))(?![`$0-9A-Za-z])",
            name: "invalid.deprecated.wolfram"
          }, {
            match: "(?:O(?:penTemporary))(?![`$0-9A-Za-z])",
            name: "invalid.deprecated.wolfram"
          }, {
            match: "(?:P(?:IDData|ackingMethod|ersistentValue|ixelConstrained|lot3Matrix|lotDivision|lotJoined|olygonIntersections|redictorInformation|roperties|roperty|ropertyList|ropertyValue))(?![`$0-9A-Za-z])",
            name: "invalid.deprecated.wolfram"
          }, {
            match: "(?:R(?:andom|asterArray|ecognitionThreshold|elease|emoteKernelObject|emoveAsynchronousTask|emoveProperty|emoveScheduledTask|enderAll|eplaceHeldPart|esetScheduledTask|esumePacket|unScheduledTask))(?![`$0-9A-Za-z])",
            name: "invalid.deprecated.wolfram"
          }, {
            ...
            match: "(?:T(?:eXSave|extStyle|imeWarpingCorrespondence|imeWarpingDistance|oDate|oFileName|oHeldExpression))(?![`$0-9A-Za-z])",
            name: "invalid.deprecated.wolfram"
          }, {
            match: "(?:U(?:RLFetch|RLFetchAsynchronous|RLSave|RLSaveAsynchronous))(?![`$0-9A-Za-z])",
            name: "invalid.deprecated.wolfram"
          }, {
            match: "(?:V(?:ectorScale|ertexCoordinateRules|ertexLabeling|ertexRenderingFunction))(?![`$0-9A-Za-z])",
            name: "invalid.deprecated.wolfram"
          }, {
            match: "(?:W(?:aitAsynchronousTask|indowMovable))(?![`$0-9A-Za-z])",
            name: "invalid.deprecated.wolfram"
          }, {
            match: "(?:\\$(?:AsynchronousTask|ConfiguredKernels|DefaultFont|EntityStores|FormatType|HTTPCookies|InstallationDate|MachineDomain|ProductInformation|ProgramName|RandomState|ScheduledTask|SummaryBoxDataSizeLimit|TemporaryPrefix|TextStyle|TopDirectory|UserAddOnsDirectory))(?![`$0-9A-Za-z])",
            name: "invalid.deprecated.wolfram"
          }, {
            ...
            match: "(?:E(?:ditButtonSettings|liminationOrder|llipticReducedHalfPeriods|mbeddingObject|mphasizeSyntaxErrors|mpty|nableConsolePrintPacket|ndAdd|ngineEnvironment|nter|qualColumns|qualRows|quatedTo|rrorBoxOptions|rrorNorm|rrorPacket|rrorsDialogSettings|valuated|valuationMode|valuationOrder|valuationRateLimit|ventEvaluator|ventHandlerTag|xactRootIsolation|xitDialog|xpectationE|xportPacket|xpressionPacket|xternalCall|xternalFunctionName))(?![`$0-9A-Za-z])",
            name: "support.function.undocumented.wolfram"
          }, {
            ...
            match: "(?:H(?:eadCompose|eaders|elpBrowserLookup|elpBrowserNotebook|elpViewerSettings|essian|exahedronBox|exahedronBoxOptions|ighlightString|omePage|orizontal|orizontalForm|orizontalScrollPosition|yperlinkCreationSettings|yphenationOptions))(?![`$0-9A-Za-z])",
            name: "support.function.undocumented.wolfram"
          }, {
            ...
            match: "(?:J(?:acobian|oinedCurveBox|oinedCurveBoxOptions))(?![`$0-9A-Za-z])",
            name: "support.function.undocumented.wolfram"
          }, {
            match: "(?:K(?:|ernelExecute|et))(?![`$0-9A-Za-z])",
            name: "support.function.undocumented.wolfram"
          }, {
            ...
            match: "(?:N(?:BernoulliB|ProductFactors|SumTerms|Values|amespaceBox|amespaceBoxOptions|estedScriptRules|etworkPacketRecordingDuring|ext|onAssociative|ormalGrouping|otebookDefault|otebookInterfaceObject))(?![`$0-9A-Za-z])",
            name: "support.function.undocumented.wolfram"
          }, {
            match: "(?:O(?:LEData|bjectExistsQ|pen|penFunctionInspectorPacket|penSpecialOptions|penerBox|penerBoxOptions|ptionQ|ptionValueBox|ptionValueBoxOptions|ptionsPacket|utputFormData|utputGrouping|utputMathEditExpression|ver|verlayBox|verlayBoxOptions))(?![`$0-9A-Za-z])",
            name: "support.function.undocumented.wolfram"
          }, {
            ...
            match: "(?:U(?:ntrackedVariables|p|seGraphicsRange|serDefinedWavelet|sing))(?![`$0-9A-Za-z])",
            name: "support.function.undocumented.wolfram"
          }, {
            match: "(?:V(?:2Get|alueBox|alueBoxOptions|alueForm|aluesData|ectorGlyphData|erbose|ertical|erticalForm|iewPointSelectorSettings|iewPort|irtualGroupData|isibleCell))(?![`$0-9A-Za-z])",
            name: "support.function.undocumented.wolfram"
          }, {
            match: "(?:W(?:aitUntil|ebPageMetaInformation|holeCellGroupOpener|indowPersistentStyles|indowSelected|indowWidth|olframAlphaDate|olframAlphaQuantity|olframAlphaResult|olframCloudSettings))(?![`$0-9A-Za-z])",
            name: "support.function.undocumented.wolfram"
          }, {
            ...
            match: "(?:H(?:andlerFunctions|andlerFunctionsKeys|ardcorePointProcess|istogramPointDensity))(?![`$0-9A-Za-z])",
            name: "support.function.experimental.wolfram"
          }, {
            ...
            match: "(?:K(?:ernelConfiguration|ernelFunction))(?![`$0-9A-Za-z])",
            name: "support.function.experimental.wolfram"
          }, {
            match: "(?:L(?:earningRateMultipliers|ibraryFunctionDeclaration|icenseEntitlementObject|icenseEntitlements|icensingSettings|inearLayer|iteralType|oadCompiledComponent|ocalResponseNormalizationLayer|ongShortTermMemoryLayer|ossFunction))(?![`$0-9A-Za-z])",
            name: "support.function.experimental.wolfram"
          }, {
            ...
            match: "(?:O(?:peratorApplied|rderingLayer|rdinalScale|utputPorts|verlayVideo))(?![`$0-9A-Za-z])",
            name: "support.function.experimental.wolfram"
          }, {
            ...
            match: "(?:Q(?:uestionGenerator|uestionInterface|uestionObject|uestionSelector))(?![`$0-9A-Za-z])",
            name: "support.function.experimental.wolfram"
          }, {
            ...
            match: "(?:U(?:RLDownloadSubmit|nconstrainedParameters|nionedEntityClass|niqueElements|nitVectorLayer|nlabeledTree|nmanageObject|nregisterExternalEvaluator|pdateSearchIndex|seEmbeddedLibrary))(?![`$0-9A-Za-z])",
            name: "support.function.experimental.wolfram"
          }, {
            match: "(?:V(?:alenceErrorHandling|alenceFilling|aluePreprocessingFunction|andermondeMatrix|arianceGammaPointProcess|ariogramFunction|ariogramModel|ectorAround|erifyDerivedKey|erifyDigitalSignature|erifyFileSignature|erifyInterpretation|ideo|ideoCapture|ideoCombine|ideoDelete|ideoExtractFrames|ideoFrameList|ideoFrameMap|ideoGenerator|ideoInsert|ideoIntervals|ideoJoin|ideoMap|ideoMapList|ideoMapTimeSeries|ideoPadding|ideoPause|ideoPlay|ideoQ|ideoRecord|ideoReplace|ideoScreenCapture|ideoSplit|ideoStop|ideoStream|ideoStreams|ideoTimeStretch|ideoTrackSelection|ideoTranscode|ideoTransparency|ideoTrim))(?![`$0-9A-Za-z])",
            name: "support.function.experimental.wolfram"
          }, {
            match: "(?:W(?:ebAudioSearch|ebColumn|ebElementObject|ebExecute|ebImage|ebImageSearch|ebItem|ebRow|ebSearch|ebSessionObject|ebSessions|ebWindowObject|ikidataData|ikidataSearch|ikipediaSearch|ithCleanup|ithLock))(?![`$0-9A-Za-z])",
            name: "support.function.experimental.wolfram"
          }, {
            match: "(?:Z(?:oomCenter|oomFactor))(?![`$0-9A-Za-z])",
            name: "support.function.experimental.wolfram"
          }, {
            match: "(?:\\$(?:AllowExternalChannelFunctions|AudioDecoders|AudioEncoders|BlockchainBase|ChannelBase|CompilerEnvironment|CookieStore|CryptographicEllipticCurveNames|CurrentWebSession|DataStructures|DefaultNetworkInterface|DefaultProxyRules|DefaultRemoteBatchSubmissionEnvironment|DefaultRemoteKernel|DefaultSystemCredentialStore|ExternalIdentifierTypes|ExternalStorageBase|GeneratedAssetLocation|IncomingMailSettings|Initialization|InitializationContexts|MaxDisplayedChildren|NetworkInterfaces|NoValue|PersistenceBase|PersistencePath|PreInitialization|PublisherID|ResourceSystemBase|ResourceSystemPath|SSHAuthentication|ServiceCreditsAvailable|SourceLink|SubtitleDecoders|SubtitleEncoders|SystemCredentialStore|TargetSystems|TestFileName|VideoDecoders|VideoEncoders|VoiceStyles))(?![`$0-9A-Za-z])",
            name: "support.function.experimental.wolfram"
          }, {
            match: "(?:A(?:llFalse|nyFalse))(?![`$0-9A-Za-z])",
            name: "invalid.bad.wolfram"
          }, {
            match: "(?:B(?:oolean))(?![`$0-9A-Za-z])",
            name: "invalid.bad.wolfram"
          }, {
            match: "(?:C(?:loudbase|omplexQ))(?![`$0-9A-Za-z])",
            name: "invalid.bad.wolfram"
          }, {
            match: "(?:D(?:ataSet))(?![`$0-9A-Za-z])",
            name: "invalid.bad.wolfram"
          }, {
            match: "(?:E(?:xpandFilename|xportPacket))(?![`$0-9A-Za-z])",
            name: "invalid.bad.wolfram"
          }, {
            match: "(?:F(?:ailed|alseQ))(?![`$0-9A-Za-z])",
            name: "invalid.bad.wolfram"
          }, {
            match: "(?:I(?:nterpolationFunction|nterpolationPolynomial))(?![`$0-9A-Za-z])",
            name: "invalid.bad.wolfram"
          }, {
            match: "(?:M(?:atch))(?![`$0-9A-Za-z])",
            name: "invalid.bad.wolfram"
          }, {
            match: "(?:O(?:ptionPattern|ptionsQ))(?![`$0-9A-Za-z])",
            name: "invalid.bad.wolfram"
          }, {
            match: "(?:R(?:ationalQ|ealQ))(?![`$0-9A-Za-z])",
            name: "invalid.bad.wolfram"
          }, {
            match: "(?:S(?:tringMatch|ymbolQ))(?![`$0-9A-Za-z])",
            name: "invalid.bad.wolfram"
          }, {
            match: "(?:U(?:nSameQ|rlExecute))(?![`$0-9A-Za-z])",
            name: "invalid.bad.wolfram"
          }, {
            match: "(?:\\$(?:PathNameSeparator|RegisteredUsername))(?![`$0-9A-Za-z])",
            name: "invalid.bad.wolfram"
          }, {
            match: "(?:E(?:cho|xit))(?![`$0-9A-Za-z])",
            name: "invalid.session.wolfram"
          }, {
            match: "(?:I(?:n|nString))(?![`$0-9A-Za-z])",
            name: "invalid.session.wolfram"
          }, {
            match: "(?:O(?:ut))(?![`$0-9A-Za-z])",
            name: "invalid.session.wolfram"
          }, {
            match: "(?:P(?:rint))(?![`$0-9A-Za-z])",
            name: "invalid.session.wolfram"
          }, {
            match: "(?:Q(?:uit))(?![`$0-9A-Za-z])",
            name: "invalid.session.wolfram"
          }, {
            match: "(?:\\$(?:HistoryLength|Line|Post|Pre|PrePrint|PreRead|SyntaxHandler))(?![`$0-9A-Za-z])",
            name: "invalid.session.wolfram"
          }, {
            match: "(?:[$A-Za-z][$0-9A-Za-z]*)(?=\\s*(\\[(?!\\s*\\[)|@(?!@)))",
            name: "variable.function.wolfram"
