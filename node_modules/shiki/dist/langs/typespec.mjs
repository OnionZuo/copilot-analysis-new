var typespec_exports = {};,__export(typespec_exports, {
  default: () => typespec
});,var lang,
  typespec,
  init_typespec = __esmMin(() => {
    lang = Object.freeze({
      ...
      repository: {
        ...
        "alias-statement": {
          begin: "\\b(alias)\\b\\s+(\\b[_$A-Za-z][_$0-9A-Za-z]*\\b|`(?:[^`\\\\]|\\\\.)*`)\\s*",
          beginCaptures: {
            1: {
        ...
        "augment-decorator-statement": {
          begin: "((@@)\\b[_$A-Za-z](?:[_$0-9A-Za-z]|\\.[_$A-Za-z])*\\b)",
          beginCaptures: {
            1: {
          ...
          end: "(?=[_$A-Za-z])|(?=,|;|@|\\)|\\}|\\b(?:extern)\\b|\\b(?:namespace|model|op|using|import|enum|alias|union|interface|dec|fn)\\b)",
        ...
        callExpression: {
          begin: "(\\b[_$A-Za-z](?:[_$0-9A-Za-z]|\\.[_$A-Za-z])*\\b)\\s*(\\()",
          beginCaptures: {
            1: {
        ...
        "const-statement": {
          begin: "\\b(const)\\b\\s+(\\b[_$A-Za-z][_$0-9A-Za-z]*\\b|`(?:[^`\\\\]|\\\\.)*`)",
          beginCaptures: {
            1: {
              name: "keyword.other.tsp"
            },
        ...
        "decorator-declaration-statement": {
          begin: "(?:(extern)\\s+)?\\b(dec)\\b\\s+(\\b[_$A-Za-z][_$0-9A-Za-z]*\\b|`(?:[^`\\\\]|\\\\.)*`)",
          beginCaptures: {
            1: {
              name: "keyword.other.tsp"
            },
        ...
        directive: {
          begin: "\\s*(#\\b[_$A-Za-z][_$0-9A-Za-z]*\\b)",
          beginCaptures: {
            1: {
        ...
        "doc-comment-param": {
          ...
          match: "((@)(?:param|template|prop))\\s+(\\b[_$A-Za-z][_$0-9A-Za-z]*\\b|`(?:[^`\\\\]|\\\\.)*`)\\b",
          name: "comment.block.tsp"
        },
        ...
        "doc-comment-unknown-tag": {
          ...
          match: "((@)(?:\\b[_$A-Za-z][_$0-9A-Za-z]*\\b|`(?:[^`\\\\]|\\\\.)*`))\\b",
          name: "comment.block.tsp"
        },
        "else-expression": {
          begin: "\\b(else)\\b",
        ...
        "enum-member": {
          begin: "(?:(\\b[_$A-Za-z][_$0-9A-Za-z]*\\b|`(?:[^`\\\\]|\\\\.)*`)\\s*(:?))",
          beginCaptures: {
            1: {
              name: "variable.name.tsp"
            },
        ...
        "enum-statement": {
          begin: "\\b(enum)\\b\\s+(\\b[_$A-Za-z][_$0-9A-Za-z]*\\b|`(?:[^`\\\\]|\\\\.)*`)",
          beginCaptures: {
            1: {
              name: "keyword.other.tsp"
            },
        ...
        "function-declaration-statement": {
          begin: "(?:(extern)\\s+)?\\b(fn)\\b\\s+(\\b[_$A-Za-z][_$0-9A-Za-z]*\\b|`(?:[^`\\\\]|\\\\.)*`)",
          beginCaptures: {
            1: {
              name: "keyword.other.tsp"
            },
        ...
        "interface-member": {
          begin: "(?:\\b(op)\\b\\s+)?(\\b[_$A-Za-z][_$0-9A-Za-z]*\\b|`(?:[^`\\\\]|\\\\.)*`)",
          beginCaptures: {
            1: {
              name: "keyword.other.tsp"
            },
        ...
        "model-property": {
          begin: '(?:(\\b[_$A-Za-z][_$0-9A-Za-z]*\\b|`(?:[^`\\\\]|\\\\.)*`)|(\\"(?:[^\\"\\\\]|\\\\.)*\\"))',
          beginCaptures: {
            1: {
              name: "variable.name.tsp"
            },
        ...
        "projection-statement": {
          begin: "\\b(projection)\\b\\s+(\\b[_$A-Za-z][_$0-9A-Za-z]*\\b|`(?:[^`\\\\]|\\\\.)*`)(#)(\\b[_$A-Za-z][_$0-9A-Za-z]*\\b|`(?:[^`\\\\]|\\\\.)*`)",
          beginCaptures: {
            1: {
              name: "keyword.other.tsp"
            },
        ...
        "scalar-constructor": {
          begin: "\\b(init)\\b\\s+(\\b[_$A-Za-z][_$0-9A-Za-z]*\\b|`(?:[^`\\\\]|\\\\.)*`)",
          beginCaptures: {
            1: {
              name: "keyword.other.tsp"
            },
        ...
        "scalar-statement": {
          begin: "\\b(scalar)\\b\\s+(\\b[_$A-Za-z][_$0-9A-Za-z]*\\b|`(?:[^`\\\\]|\\\\.)*`)",
          beginCaptures: {
            1: {
              name: "keyword.other.tsp"
            },
        ...
        "union-statement": {
          begin: "\\b(union)\\b\\s+(\\b[_$A-Za-z][_$0-9A-Za-z]*\\b|`(?:[^`\\\\]|\\\\.)*`)",
          beginCaptures: {
            1: {
              name: "keyword.other.tsp"
            },
